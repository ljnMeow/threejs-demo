...
`].filter(fr).join(`
`)),a=ia(a),a=Rc(a,t),a=Dc(a,t),o=ia(o),o=Rc(o,t),o=Dc(o,t),a=Ic(a),o=Ic(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(w=`#version 300 es
...
`)+`
`+_);const y=w+d+a,T=w+_+o,S=Lc(r,35633,y),R=Lc(r,35632,T);if(r.attachShader(p,S),r.attachShader(p,R),t.index0AttributeName!==void 0?r.bindAttribLocation(p,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(p,0,"position"),r.linkProgram(p),n.debug.checkShaderErrors){const L=r.getProgramInfoLog(p).trim(),O=r.getShaderInfoLog(S).trim(),$=r.getShaderInfoLog(R).trim();let he=!0,z=!0;if(r.getProgramParameter(p,35714)===!1){he=!1;const U=Pc(r,S,"vertex"),ee=Pc(r,R,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(p,35715)+`

Program Info Log: `+L+`
`+U+`
`+ee)}else L!==""?console.warn("THREE.WebGLProgram: Program Info Log:",L):(O===""||$==="")&&(z=!1);z&&(this.diagnostics={runnable:he,programLog:L,vertexShader:{log:O,prefix:d},fragmentShader:{log:$,prefix:_}})}r.deleteShader(S),r.deleteShader(R);let B;this.getUniforms=function(){return B===void 0&&(B=new ms(r,p)),B};let v;return this.getAttributes=function(){return v===void 0&&(v=Pv(r,p)),v},this.destroy=function(){i.releaseStatesOfProgram(this),r.deleteProgram(p),this.program=void 0},this.name=t.shaderName,this.id=Sv++,this.cacheKey=e,this.usedTimes=1,this.program=p,this.vertexShader=S,this.fragmentShader=R,this}let Gv=0;class Hv{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,i=e.fragmentShader,r=this._getShaderStage(t),s=this._getShaderStage(i),a=this._getShaderCacheForMaterial(e);return a.has(r)===!1&&(a.add(r),r.usedTimes++),a.has(s)===!1&&(a.add(s),s.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const i of t)i.usedTimes--,i.usedTimes===0&&this.shaderCache.delete(i.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let i=t.get(e);return i===void 0&&(i=new Set,t.set(e,i)),i}_getShaderStage(e){const t=this.shaderCache;let i=t.get(e);return i===void 0&&(i=new Vv(e),t.set(e,i)),i}}class Vv{constructor(e){this.id=Gv++,this.code=e,this.usedTimes=0}}function Wv(n,e,t,i,r,s,a){const o=new mf,l=new Hv,c=[],u=r.isWebGL2,f=r.logarithmicDepthBuffer,h=r.vertexTextures;let m=r.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distanceRGBA",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function p(v,L,O,$,he){const z=$.fog,U=he.geometry,ee=v.isMeshStandardMaterial?$.environment:null,se=(v.isMeshStandardMaterial?t:e).get(v.envMap||ee),te=se&&se.mapping===Is?se.image.height:null,W=g[v.type];v.precision!==null&&(m=r.getMaxPrecision(v.precision),m!==v.precision&&console.warn("THREE.WebGLProgram.getParameters:",v.precision,"not supported, using",m,"instead."));const de=U.morphAttributes.position||U.morphAttributes.normal||U.morphAttributes.color,ue=de!==void 0?de.length:0;let q=0;U.morphAttributes.position!==void 0&&(q=1),U.morphAttributes.normal!==void 0&&(q=2),U.morphAttributes.color!==void 0&&(q=3);let Y,fe,_e,I;if(W){const Ee=on[W];Y=Ee.vertexShader,fe=Ee.fragmentShader}else Y=v.vertexShader,fe=v.fragmentShader,l.update(v),_e=l.getVertexShaderID(v),I=l.getFragmentShaderID(v);const P=n.getRenderTarget(),ae=v.alphaTest>0,ie=v.clearcoat>0,ve=v.iridescence>0;return{isWebGL2:u,shaderID:W,shaderName:v.type,vertexShader:Y,fragmentShader:fe,defines:v.defines,customVertexShaderID:_e,customFragmentShaderID:I,isRawShaderMaterial:v.isRawShaderMaterial===!0,glslVersion:v.glslVersion,precision:m,instancing:he.isInstancedMesh===!0,instancingColor:he.isInstancedMesh===!0&&he.instanceColor!==null,supportsVertexTextures:h,outputEncoding:P===null?n.outputEncoding:P.isXRRenderTarget===!0?P.texture.encoding:ui,map:!!v.map,matcap:!!v.matcap,envMap:!!se,envMapMode:se&&se.mapping,envMapCubeUVHeight:te,lightMap:!!v.lightMap,aoMap:!!v.aoMap,emissiveMap:!!v.emissiveMap,bumpMap:!!v.bumpMap,normalMap:!!v.normalMap,objectSpaceNormalMap:v.normalMapType===pg,tangentSpaceNormalMap:v.normalMapType===dg,decodeVideoTexture:!!v.map&&v.map.isVideoTexture===!0&&v.map.encoding===$e,clearcoat:ie,clearcoatMap:ie&&!!v.clearcoatMap,clearcoatRoughnessMap:ie&&!!v.clearcoatRoughnessMap,clearcoatNormalMap:ie&&!!v.clearcoatNormalMap,iridescence:ve,iridescenceMap:ve&&!!v.iridescenceMap,iridescenceThicknessMap:ve&&!!v.iridescenceThicknessMap,displacementMap:!!v.displacementMap,roughnessMap:!!v.roughnessMap,metalnessMap:!!v.metalnessMap,specularMap:!!v.specularMap,specularIntensityMap:!!v.specularIntensityMap,specularColorMap:!!v.specularColorMap,opaque:v.transparent===!1&&v.blending===ki,alphaMap:!!v.alphaMap,alphaTest:ae,gradientMap:!!v.gradientMap,sheen:v.sheen>0,sheenColorMap:!!v.sheenColorMap,sheenRoughnessMap:!!v.sheenRoughnessMap,transmission:v.transmission>0,transmissionMap:!!v.transmissionMap,thicknessMap:!!v.thicknessMap,combine:v.combine,vertexTangents:!!v.normalMap&&!!U.attributes.tangent,vertexColors:v.vertexColors,vertexAlphas:v.vertexColors===!0&&!!U.attributes.color&&U.attributes.color.itemSize===4,vertexUvs:!!v.map||!!v.bumpMap||!!v.normalMap||!!v.specularMap||!!v.alphaMap||!!v.emissiveMap||!!v.roughnessMap||!!v.metalnessMap||!!v.clearcoatMap||!!v.clearcoatRoughnessMap||!!v.clearcoatNormalMap||!!v.iridescenceMap||!!v.iridescenceThicknessMap||!!v.displacementMap||!!v.transmissionMap||!!v.thicknessMap||!!v.specularIntensityMap||!!v.specularColorMap||!!v.sheenColorMap||!!v.sheenRoughnessMap,uvsVertexOnly:!(v.map||v.bumpMap||v.normalMap||v.specularMap||v.alphaMap||v.emissiveMap||v.roughnessMap||v.metalnessMap||v.clearcoatNormalMap||v.iridescenceMap||v.iridescenceThicknessMap||v.transmission>0||v.transmissionMap||v.thicknessMap||v.specularIntensityMap||v.specularColorMap||v.sheen>0||v.sheenColorMap||v.sheenRoughnessMap)&&!!v.displacementMap,fog:!!z,useFog:v.fog===!0,fogExp2:z&&z.isFogExp2,flatShading:!!v.flatShading,sizeAttenuation:v.sizeAttenuation,logarithmicDepthBuffer:f,skinning:he.isSkinnedMesh===!0,morphTargets:U.morphAttributes.position!==void 0,morphNormals:U.morphAttributes.normal!==void 0,morphColors:U.morphAttributes.color!==void 0,morphTargetsCount:ue,morphTextureStride:q,numDirLights:L.directional.length,numPointLights:L.point.length,numSpotLights:L.spot.length,numSpotLightMaps:L.spotLightMap.length,numRectAreaLights:L.rectArea.length,numHemiLights:L.hemi.length,numDirLightShadows:L.directionalShadowMap.length,numPointLightShadows:L.pointShadowMap.length,numSpotLightShadows:L.spotShadowMap.length,numSpotLightShadowsWithMaps:L.numSpotLightShadowsWithMaps,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:v.dithering,shadowMapEnabled:n.shadowMap.enabled&&O.length>0,shadowMapType:n.shadowMap.type,toneMapping:v.toneMapped?n.toneMapping:Mn,physicallyCorrectLights:n.physicallyCorrectLights,premultipliedAlpha:v.premultipliedAlpha,doubleSided:v.side===Ra,flipSided:v.side===Vt,useDepthPacking:!!v.depthPacking,depthPacking:v.depthPacking||0,index0AttributeName:v.index0AttributeName,extensionDerivatives:v.extensions&&v.extensions.derivatives,extensionFragDepth:v.extensions&&v.extensions.fragDepth,extensionDrawBuffers:v.extensions&&v.extensions.drawBuffers,extensionShaderTextureLOD:v.extensions&&v.extensions.shaderTextureLOD,rendererExtensionFragDepth:u||i.has("EXT_frag_depth"),rendererExtensionDrawBuffers:u||i.has("WEBGL_draw_buffers"),rendererExtensionShaderTextureLod:u||i.has("EXT_shader_texture_lod"),customProgramCacheKey:v.customProgramCacheKey()}}function d(v){const L=[];if(v.shaderID?L.push(v.shaderID):(L.push(v.customVertexShaderID),L.push(v.customFragmentShaderID)),v.defines!==void 0)for(const O in v.defines)L.push(O),L.push(v.defines[O]);return v.isRawShaderMaterial===!1&&(_(L,v),w(L,v),L.push(n.outputEncoding)),L.push(v.customProgramCacheKey),L.join()}function _(v,L){v.push(L.precision),v.push(L.outputEncoding),v.push(L.envMapMode),v.push(L.envMapCubeUVHeight),v.push(L.combine),v.push(L.vertexUvs),v.push(L.fogExp2),v.push(L.sizeAttenuation),v.push(L.morphTargetsCount),v.push(L.morphAttributeCount),v.push(L.numDirLights),v.push(L.numPointLights),v.push(L.numSpotLights),v.push(L.numSpotLightMaps),v.push(L.numHemiLights),v.push(L.numRectAreaLights),v.push(L.numDirLightShadows),v.push(L.numPointLightShadows),v.push(L.numSpotLightShadows),v.push(L.numSpotLightShadowsWithMaps),v.push(L.shadowMapType),v.push(L.toneMapping),v.push(L.numClippingPlanes),v.push(L.numClipIntersection),v.push(L.depthPacking)}function w(v,L){o.disableAll(),L.isWebGL2&&o.enable(0),L.supportsVertexTextures&&o.enable(1),L.instancing&&o.enable(2),L.instancingColor&&o.enable(3),L.map&&o.enable(4),L.matcap&&o.enable(5),L.envMap&&o.enable(6),L.lightMap&&o.enable(7),L.aoMap&&o.enable(8),L.emissiveMap&&o.enable(9),L.bumpMap&&o.enable(10),L.normalMap&&o.enable(11),L.objectSpaceNormalMap&&o.enable(12),L.tangentSpaceNormalMap&&o.enable(13),L.clearcoat&&o.enable(14),L.clearcoatMap&&o.enable(15),L.clearcoatRoughnessMap&&o.enable(16),L.clearcoatNormalMap&&o.enable(17),L.iridescence&&o.enable(18),L.iridescenceMap&&o.enable(19),L.iridescenceThicknessMap&&o.enable(20),L.displacementMap&&o.enable(21),L.specularMap&&o.enable(22),L.roughnessMap&&o.enable(23),L.metalnessMap&&o.enable(24),L.gradientMap&&o.enable(25),L.alphaMap&&o.enable(26),L.alphaTest&&o.enable(27),L.vertexColors&&o.enable(28),L.vertexAlphas&&o.enable(29),L.vertexUvs&&o.enable(30),L.vertexTangents&&o.enable(31),L.uvsVertexOnly&&o.enable(32),v.push(o.mask),o.disableAll(),L.fog&&o.enable(0),L.useFog&&o.enable(1),L.flatShading&&o.enable(2),L.logarithmicDepthBuffer&&o.enable(3),L.skinning&&o.enable(4),L.morphTargets&&o.enable(5),L.morphNormals&&o.enable(6),L.morphColors&&o.enable(7),L.premultipliedAlpha&&o.enable(8),L.shadowMapEnabled&&o.enable(9),L.physicallyCorrectLights&&o.enable(10),L.doubleSided&&o.enable(11),L.flipSided&&o.enable(12),L.useDepthPacking&&o.enable(13),L.dithering&&o.enable(14),L.specularIntensityMap&&o.enable(15),L.specularColorMap&&o.enable(16),L.transmission&&o.enable(17),L.transmissionMap&&o.enable(18),L.thicknessMap&&o.enable(19),L.sheen&&o.enable(20),L.sheenColorMap&&o.enable(21),L.sheenRoughnessMap&&o.enable(22),L.decodeVideoTexture&&o.enable(23),L.opaque&&o.enable(24),v.push(o.mask)}function y(v){const L=g[v.type];let O;if(L){const $=on[L];O=Pg.clone($.uniforms)}else O=v.uniforms;return O}function T(v,L){let O;for(let $=0,he=c.length;$<he;$++){const z=c[$];if(z.cacheKey===L){O=z,++O.usedTimes;break}}return O===void 0&&(O=new kv(n,L,v,s),c.push(O)),O}function S(v){if(--v.usedTimes===0){const L=c.indexOf(v);c[L]=c[c.length-1],c.pop(),v.destroy()}}function R(v){l.remove(v)}function B(){l.dispose()}return{getParameters:p,getProgramCacheKey:d,getUniforms:y,acquireProgram:T,releaseProgram:S,releaseShaderCache:R,programs:c,dispose:B}}function qv(){let n=new WeakMap;function e(s){let a=n.get(s);return a===void 0&&(a={},n.set(s,a)),a}function t(s){n.delete(s)}function i(s,a,o){n.get(s)[a]=o}function r(){n=new WeakMap}return{get:e,remove:t,update:i,dispose:r}}function Xv(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.material.id!==e.material.id?n.material.id-e.material.id:n.z!==e.z?n.z-e.z:n.id-e.id}function Oc(n,e){return n.groupOrder!==e.groupOrder?n.groupOrder-e.groupOrder:n.renderOrder!==e.renderOrder?n.renderOrder-e.renderOrder:n.z!==e.z?e.z-n.z:n.id-e.id}function Nc(){const n=[];let e=0;const t=[],i=[],r=[];function s(){e=0,t.length=0,i.length=0,r.length=0}function a(f,h,m,g,p,d){let _=n[e];return _===void 0?(_={id:f.id,object:f,geometry:h,material:m,groupOrder:g,renderOrder:f.renderOrder,z:p,group:d},n[e]=_):(_.id=f.id,_.object=f,_.geometry=h,_.material=m,_.groupOrder=g,_.renderOrder=f.renderOrder,_.z=p,_.group=d),e++,_}function o(f,h,m,g,p,d){const _=a(f,h,m,g,p,d);m.transmission>0?i.push(_):m.transparent===!0?r.push(_):t.push(_)}function l(f,h,m,g,p,d){const _=a(f,h,m,g,p,d);m.transmission>0?i.unshift(_):m.transparent===!0?r.unshift(_):t.unshift(_)}function c(f,h){t.length>1&&t.sort(f||Xv),i.length>1&&i.sort(h||Oc),r.length>1&&r.sort(h||Oc)}function u(){for(let f=e,h=n.length;f<h;f++){const m=n[f];if(m.id===null)break;m.id=null,m.object=null,m.geometry=null,m.material=null,m.group=null}}return{opaque:t,transmissive:i,transparent:r,init:s,push:o,unshift:l,finish:u,sort:c}}function jv(){let n=new WeakMap;function e(i,r){const s=n.get(i);let a;return s===void 0?(a=new Nc,n.set(i,[a])):r>=s.length?(a=new Nc,s.push(a)):a=s[r],a}function t(){n=new WeakMap}return{get:e,dispose:t}}function Yv(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new V,color:new Ke};break;case"SpotLight":t={position:new V,direction:new V,color:new Ke,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new V,color:new Ke,distance:0,decay:0};break;case"HemisphereLight":t={direction:new V,skyColor:new Ke,groundColor:new Ke};break;case"RectAreaLight":t={color:new Ke,position:new V,halfWidth:new V,halfHeight:new V};break}return n[e.id]=t,t}}}function $v(){const n={};return{get:function(e){if(n[e.id]!==void 0)return n[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ue};break;case"SpotLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ue};break;case"PointLight":t={shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new Ue,shadowCameraNear:1,shadowCameraFar:1e3};break}return n[e.id]=t,t}}}let Kv=0;function Zv(n,e){return(e.castShadow?2:0)-(n.castShadow?2:0)+(e.map?1:0)-(n.map?1:0)}function Jv(n,e){const t=new Yv,i=$v(),r={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0};for(let u=0;u<9;u++)r.probe.push(new V);const s=new V,a=new rt,o=new rt;function l(u,f){let h=0,m=0,g=0;for(let $=0;$<9;$++)r.probe[$].set(0,0,0);let p=0,d=0,_=0,w=0,y=0,T=0,S=0,R=0,B=0,v=0;u.sort(Zv);const L=f!==!0?Math.PI:1;for(let $=0,he=u.length;$<he;$++){const z=u[$],U=z.color,ee=z.intensity,se=z.distance,te=z.shadow&&z.shadow.map?z.shadow.map.texture:null;if(z.isAmbientLight)h+=U.r*ee*L,m+=U.g*ee*L,g+=U.b*ee*L;else if(z.isLightProbe)for(let W=0;W<9;W++)r.probe[W].addScaledVector(z.sh.coefficients[W],ee);else if(z.isDirectionalLight){const W=t.get(z);if(W.color.copy(z.color).multiplyScalar(z.intensity*L),z.castShadow){const de=z.shadow,ue=i.get(z);ue.shadowBias=de.bias,ue.shadowNormalBias=de.normalBias,ue.shadowRadius=de.radius,ue.shadowMapSize=de.mapSize,r.directionalShadow[p]=ue,r.directionalShadowMap[p]=te,r.directionalShadowMatrix[p]=z.shadow.matrix,T++}r.directional[p]=W,p++}else if(z.isSpotLight){const W=t.get(z);W.position.setFromMatrixPosition(z.matrixWorld),W.color.copy(U).multiplyScalar(ee*L),W.distance=se,W.coneCos=Math.cos(z.angle),W.penumbraCos=Math.cos(z.angle*(1-z.penumbra)),W.decay=z.decay,r.spot[_]=W;const de=z.shadow;if(z.map&&(r.spotLightMap[B]=z.map,B++,de.updateMatrices(z),z.castShadow&&v++),r.spotLightMatrix[_]=de.matrix,z.castShadow){const ue=i.get(z);ue.shadowBias=de.bias,ue.shadowNormalBias=de.normalBias,ue.shadowRadius=de.radius,ue.shadowMapSize=de.mapSize,r.spotShadow[_]=ue,r.spotShadowMap[_]=te,R++}_++}else if(z.isRectAreaLight){const W=t.get(z);W.color.copy(U).multiplyScalar(ee),W.halfWidth.set(z.width*.5,0,0),W.halfHeight.set(0,z.height*.5,0),r.rectArea[w]=W,w++}else if(z.isPointLight){const W=t.get(z);if(W.color.copy(z.color).multiplyScalar(z.intensity*L),W.distance=z.distance,W.decay=z.decay,z.castShadow){const de=z.shadow,ue=i.get(z);ue.shadowBias=de.bias,ue.shadowNormalBias=de.normalBias,ue.shadowRadius=de.radius,ue.shadowMapSize=de.mapSize,ue.shadowCameraNear=de.camera.near,ue.shadowCameraFar=de.camera.far,r.pointShadow[d]=ue,r.pointShadowMap[d]=te,r.pointShadowMatrix[d]=z.shadow.matrix,S++}r.point[d]=W,d++}else if(z.isHemisphereLight){const W=t.get(z);W.skyColor.copy(z.color).multiplyScalar(ee*L),W.groundColor.copy(z.groundColor).multiplyScalar(ee*L),r.hemi[y]=W,y++}}w>0&&(e.isWebGL2||n.has("OES_texture_float_linear")===!0?(r.rectAreaLTC1=ye.LTC_FLOAT_1,r.rectAreaLTC2=ye.LTC_FLOAT_2):n.has("OES_texture_half_float_linear")===!0?(r.rectAreaLTC1=ye.LTC_HALF_1,r.rectAreaLTC2=ye.LTC_HALF_2):console.error("THREE.WebGLRenderer: Unable to use RectAreaLight. Missing WebGL extensions.")),r.ambient[0]=h,r.ambient[1]=m,r.ambient[2]=g;const O=r.hash;(O.directionalLength!==p||O.pointLength!==d||O.spotLength!==_||O.rectAreaLength!==w||O.hemiLength!==y||O.numDirectionalShadows!==T||O.numPointShadows!==S||O.numSpotShadows!==R||O.numSpotMaps!==B)&&(r.directional.length=p,r.spot.length=_,r.rectArea.length=w,r.point.length=d,r.hemi.length=y,r.directionalShadow.length=T,r.directionalShadowMap.length=T,r.pointShadow.length=S,r.pointShadowMap.length=S,r.spotShadow.length=R,r.spotShadowMap.length=R,r.directionalShadowMatrix.length=T,r.pointShadowMatrix.length=S,r.spotLightMatrix.length=R+B-v,r.spotLightMap.length=B,r.numSpotLightShadowsWithMaps=v,O.directionalLength=p,O.pointLength=d,O.spotLength=_,O.rectAreaLength=w,O.hemiLength=y,O.numDirectionalShadows=T,O.numPointShadows=S,O.numSpotShadows=R,O.numSpotMaps=B,r.version=Kv++)}function c(u,f){let h=0,m=0,g=0,p=0,d=0;const _=f.matrixWorldInverse;for(let w=0,y=u.length;w<y;w++){const T=u[w];if(T.isDirectionalLight){const S=r.directional[h];S.direction.setFromMatrixPosition(T.matrixWorld),s.setFromMatrixPosition(T.target.matrixWorld),S.direction.sub(s),S.direction.transformDirection(_),h++}else if(T.isSpotLight){const S=r.spot[g];S.position.setFromMatrixPosition(T.matrixWorld),S.position.applyMatrix4(_),S.direction.setFromMatrixPosition(T.matrixWorld),s.setFromMatrixPosition(T.target.matrixWorld),S.direction.sub(s),S.direction.transformDirection(_),g++}else if(T.isRectAreaLight){const S=r.rectArea[p];S.position.setFromMatrixPosition(T.matrixWorld),S.position.applyMatrix4(_),o.identity(),a.copy(T.matrixWorld),a.premultiply(_),o.extractRotation(a),S.halfWidth.set(T.width*.5,0,0),S.halfHeight.set(0,T.height*.5,0),S.halfWidth.applyMatrix4(o),S.halfHeight.applyMatrix4(o),p++}else if(T.isPointLight){const S=r.point[m];S.position.setFromMatrixPosition(T.matrixWorld),S.position.applyMatrix4(_),m++}else if(T.isHemisphereLight){const S=r.hemi[d];S.direction.setFromMatrixPosition(T.matrixWorld),S.direction.transformDirection(_),d++}}}return{setup:l,setupView:c,state:r}}function Uc(n,e){const t=new Jv(n,e),i=[],r=[];function s(){i.length=0,r.length=0}function a(f){i.push(f)}function o(f){r.push(f)}function l(f){t.setup(i,f)}function c(f){t.setupView(i,f)}return{init:s,state:{lightsArray:i,shadowsArray:r,lights:t},setupLights:l,setupLightsView:c,pushLight:a,pushShadow:o}}function Qv(n,e){let t=new WeakMap;function i(s,a=0){const o=t.get(s);let l;return o===void 0?(l=new Uc(n,e),t.set(s,[l])):a>=o.length?(l=new Uc(n,e),o.push(l)):l=o[a],l}function r(){t=new WeakMap}return{get:i,dispose:r}}class ey extends Dr{constructor(e){super(),this.isMeshDepthMaterial=!0,this.type="MeshDepthMaterial",this.depthPacking=fg,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.wireframe=!1,this.wireframeLinewidth=1,this.setValues(e)}copy(e){return super.copy(e),this.depthPacking=e.depthPacking,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this.wireframe=e.wireframe,this.wireframeLinewidth=e.wireframeLinewidth,this}}class ty extends Dr{constructor(e){super(),this.isMeshDistanceMaterial=!0,this.type="MeshDistanceMaterial",this.referencePosition=new V,this.nearDistance=1,this.farDistance=1e3,this.map=null,this.alphaMap=null,this.displacementMap=null,this.displacementScale=1,this.displacementBias=0,this.setValues(e)}copy(e){return super.copy(e),this.referencePosition.copy(e.referencePosition),this.nearDistance=e.nearDistance,this.farDistance=e.farDistance,this.map=e.map,this.alphaMap=e.alphaMap,this.displacementMap=e.displacementMap,this.displacementScale=e.displacementScale,this.displacementBias=e.displacementBias,this}}const ny=`void main() {
	gl_Position = vec4( position, 1.0 );
...
}`;function ry(n,e,t){let i=new Da;const r=new Ue,s=new Ue,a=new ft,o=new ey({depthPacking:hg}),l=new ty,c={},u=t.maxTextureSize,f={0:Vt,1:li,2:Ra},h=new di({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ue},radius:{value:4}},vertexShader:ny,fragmentShader:iy}),m=h.clone();m.defines.HORIZONTAL_PASS=1;const g=new wn;g.setAttribute("position",new Qt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const p=new In(g,h),d=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=nf,this.render=function(T,S,R){if(d.enabled===!1||d.autoUpdate===!1&&d.needsUpdate===!1||T.length===0)return;const B=n.getRenderTarget(),v=n.getActiveCubeFace(),L=n.getActiveMipmapLevel(),O=n.state;O.setBlending(Nn),O.buffers.color.setClear(1,1,1,1),O.buffers.depth.setTest(!0),O.setScissorTest(!1);for(let $=0,he=T.length;$<he;$++){const z=T[$],U=z.shadow;if(U===void 0){console.warn("THREE.WebGLShadowMap:",z,"has no shadow.");continue}if(U.autoUpdate===!1&&U.needsUpdate===!1)continue;r.copy(U.mapSize);const ee=U.getFrameExtents();if(r.multiply(ee),s.copy(U.mapSize),(r.x>u||r.y>u)&&(r.x>u&&(s.x=Math.floor(u/ee.x),r.x=s.x*ee.x,U.mapSize.x=s.x),r.y>u&&(s.y=Math.floor(u/ee.y),r.y=s.y*ee.y,U.mapSize.y=s.y)),U.map===null){const te=this.type!==ur?{minFilter:St,magFilter:St}:{};U.map=new fi(r.x,r.y,te),U.map.texture.name=z.name+".shadowMap",U.camera.updateProjectionMatrix()}n.setRenderTarget(U.map),n.clear();const se=U.getViewportCount();for(let te=0;te<se;te++){const W=U.getViewport(te);a.set(s.x*W.x,s.y*W.y,s.x*W.z,s.y*W.w),O.viewport(a),U.updateMatrices(z,te),i=U.getFrustum(),y(S,R,U.camera,z,this.type)}U.isPointLightShadow!==!0&&this.type===ur&&_(U,R),U.needsUpdate=!1}d.needsUpdate=!1,n.setRenderTarget(B,v,L)};function _(T,S){const R=e.update(p);h.defines.VSM_SAMPLES!==T.blurSamples&&(h.defines.VSM_SAMPLES=T.blurSamples,m.defines.VSM_SAMPLES=T.blurSamples,h.needsUpdate=!0,m.needsUpdate=!0),T.mapPass===null&&(T.mapPass=new fi(r.x,r.y)),h.uniforms.shadow_pass.value=T.map.texture,h.uniforms.resolution.value=T.mapSize,h.uniforms.radius.value=T.radius,n.setRenderTarget(T.mapPass),n.clear(),n.renderBufferDirect(S,null,R,h,p,null),m.uniforms.shadow_pass.value=T.mapPass.texture,m.uniforms.resolution.value=T.mapSize,m.uniforms.radius.value=T.radius,n.setRenderTarget(T.map),n.clear(),n.renderBufferDirect(S,null,R,m,p,null)}function w(T,S,R,B,v,L){let O=null;const $=R.isPointLight===!0?T.customDistanceMaterial:T.customDepthMaterial;if($!==void 0)O=$;else if(O=R.isPointLight===!0?l:o,n.localClippingEnabled&&S.clipShadows===!0&&Array.isArray(S.clippingPlanes)&&S.clippingPlanes.length!==0||S.displacementMap&&S.displacementScale!==0||S.alphaMap&&S.alphaTest>0||S.map&&S.alphaTest>0){const he=O.uuid,z=S.uuid;let U=c[he];U===void 0&&(U={},c[he]=U);let ee=U[z];ee===void 0&&(ee=O.clone(),U[z]=ee),O=ee}return O.visible=S.visible,O.wireframe=S.wireframe,L===ur?O.side=S.shadowSide!==null?S.shadowSide:S.side:O.side=S.shadowSide!==null?S.shadowSide:f[S.side],O.alphaMap=S.alphaMap,O.alphaTest=S.alphaTest,O.map=S.map,O.clipShadows=S.clipShadows,O.clippingPlanes=S.clippingPlanes,O.clipIntersection=S.clipIntersection,O.displacementMap=S.displacementMap,O.displacementScale=S.displacementScale,O.displacementBias=S.displacementBias,O.wireframeLinewidth=S.wireframeLinewidth,O.linewidth=S.linewidth,R.isPointLight===!0&&O.isMeshDistanceMaterial===!0&&(O.referencePosition.setFromMatrixPosition(R.matrixWorld),O.nearDistance=B,O.farDistance=v),O}function y(T,S,R,B,v){if(T.visible===!1)return;if(T.layers.test(S.layers)&&(T.isMesh||T.isLine||T.isPoints)&&(T.castShadow||T.receiveShadow&&v===ur)&&(!T.frustumCulled||i.intersectsObject(T))){T.modelViewMatrix.multiplyMatrices(R.matrixWorldInverse,T.matrixWorld);const $=e.update(T),he=T.material;if(Array.isArray(he)){const z=$.groups;for(let U=0,ee=z.length;U<ee;U++){const se=z[U],te=he[se.materialIndex];if(te&&te.visible){const W=w(T,te,B,R.near,R.far,v);n.renderBufferDirect(R,null,$,W,T,se)}}}else if(he.visible){const z=w(T,he,B,R.near,R.far,v);n.renderBufferDirect(R,null,$,z,T,null)}}const O=T.children;for(let $=0,he=O.length;$<he;$++)y(O[$],S,R,B,v)}}function sy(n,e,t){const i=t.isWebGL2;function r(){let D=!1;const Z=new ft;let ge=null;const Ae=new ft(0,0,0,0);return{setMask:function(Le){ge!==Le&&!D&&(n.colorMask(Le,Le,Le,Le),ge=Le)},setLocked:function(Le){D=Le},setClear:function(Le,Xe,lt,pt,Bn){Bn===!0&&(Le*=pt,Xe*=pt,lt*=pt),Z.set(Le,Xe,lt,pt),Ae.equals(Z)===!1&&(n.clearColor(Le,Xe,lt,pt),Ae.copy(Z))},reset:function(){D=!1,ge=null,Ae.set(-1,0,0,0)}}}function s(){let D=!1,Z=null,ge=null,Ae=null;return{setTest:function(Le){Le?ae(2929):ie(2929)},setMask:function(Le){Z!==Le&&!D&&(n.depthMask(Le),Z=Le)},setFunc:function(Le){if(ge!==Le){switch(Le){case Om:n.depthFunc(512);break;case Nm:n.depthFunc(519);break;case Um:n.depthFunc(513);break;case Ko:n.depthFunc(515);break;case zm:n.depthFunc(514);break;case Bm:n.depthFunc(518);break;case km:n.depthFunc(516);break;case Gm:n.depthFunc(517);break;default:n.depthFunc(515)}ge=Le}},setLocked:function(Le){D=Le},setClear:function(Le){Ae!==Le&&(n.clearDepth(Le),Ae=Le)},reset:function(){D=!1,Z=null,ge=null,Ae=null}}}function a(){let D=!1,Z=null,ge=null,Ae=null,Le=null,Xe=null,lt=null,pt=null,Bn=null;return{setTest:function(Ze){D||(Ze?ae(2960):ie(2960))},setMask:function(Ze){Z!==Ze&&!D&&(n.stencilMask(Ze),Z=Ze)},setFunc:function(Ze,cn,Ot){(ge!==Ze||Ae!==cn||Le!==Ot)&&(n.stencilFunc(Ze,cn,Ot),ge=Ze,Ae=cn,Le=Ot)},setOp:function(Ze,cn,Ot){(Xe!==Ze||lt!==cn||pt!==Ot)&&(n.stencilOp(Ze,cn,Ot),Xe=Ze,lt=cn,pt=Ot)},setLocked:function(Ze){D=Ze},setClear:function(Ze){Bn!==Ze&&(n.clearStencil(Ze),Bn=Ze)},reset:function(){D=!1,Z=null,ge=null,Ae=null,Le=null,Xe=null,lt=null,pt=null,Bn=null}}}const o=new r,l=new s,c=new a,u=new WeakMap,f=new WeakMap;let h={},m={},g=new WeakMap,p=[],d=null,_=!1,w=null,y=null,T=null,S=null,R=null,B=null,v=null,L=!1,O=null,$=null,he=null,z=null,U=null;const ee=n.getParameter(35661);let se=!1,te=0;const W=n.getParameter(7938);W.indexOf("WebGL")!==-1?(te=parseFloat(/^WebGL (\d)/.exec(W)[1]),se=te>=1):W.indexOf("OpenGL ES")!==-1&&(te=parseFloat(/^OpenGL ES (\d)/.exec(W)[1]),se=te>=2);let de=null,ue={};const q=n.getParameter(3088),Y=n.getParameter(2978),fe=new ft().fromArray(q),_e=new ft().fromArray(Y);function I(D,Z,ge){const Ae=new Uint8Array(4),Le=n.createTexture();n.bindTexture(D,Le),n.texParameteri(D,10241,9728),n.texParameteri(D,10240,9728);for(let Xe=0;Xe<ge;Xe++)n.texImage2D(Z+Xe,0,6408,1,1,0,6408,5121,Ae);return Le}const P={};P[3553]=I(3553,3553,1),P[34067]=I(34067,34069,6),o.setClear(0,0,0,1),l.setClear(1),c.setClear(0),ae(2929),l.setFunc(Ko),K(!1),le(Ll),ae(2884),H(Nn);function ae(D){h[D]!==!0&&(n.enable(D),h[D]=!0)}function ie(D){h[D]!==!1&&(n.disable(D),h[D]=!1)}function ve(D,Z){return m[D]!==Z?(n.bindFramebuffer(D,Z),m[D]=Z,i&&(D===36009&&(m[36160]=Z),D===36160&&(m[36009]=Z)),!0):!1}function xe(D,Z){let ge=p,Ae=!1;if(D)if(ge=g.get(Z),ge===void 0&&(ge=[],g.set(Z,ge)),D.isWebGLMultipleRenderTargets){const Le=D.texture;if(ge.length!==Le.length||ge[0]!==36064){for(let Xe=0,lt=Le.length;Xe<lt;Xe++)ge[Xe]=36064+Xe;ge.length=Le.length,Ae=!0}}else ge[0]!==36064&&(ge[0]=36064,Ae=!0);else ge[0]!==1029&&(ge[0]=1029,Ae=!0);Ae&&(t.isWebGL2?n.drawBuffers(ge):e.get("WEBGL_draw_buffers").drawBuffersWEBGL(ge))}function Ee(D){return d!==D?(n.useProgram(D),d=D,!0):!1}const b={[Ii]:32774,[wm]:32778,[Em]:32779};if(i)b[Dl]=32775,b[Il]=32776;else{const D=e.get("EXT_blend_minmax");D!==null&&(b[Dl]=D.MIN_EXT,b[Il]=D.MAX_EXT)}const A={[Tm]:0,[Am]:1,[Cm]:768,[rf]:770,[Fm]:776,[Dm]:774,[Pm]:772,[Lm]:769,[sf]:771,[Im]:775,[Rm]:773};function H(D,Z,ge,Ae,Le,Xe,lt,pt){if(D===Nn){_===!0&&(ie(3042),_=!1);return}if(_===!1&&(ae(3042),_=!0),D!==Sm){if(D!==w||pt!==L){if((y!==Ii||R!==Ii)&&(n.blendEquation(32774),y=Ii,R=Ii),pt)switch(D){case ki:n.blendFuncSeparate(1,771,1,771);break;case $o:n.blendFunc(1,1);break;case Pl:n.blendFuncSeparate(0,769,0,1);break;case Rl:n.blendFuncSeparate(0,768,0,770);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}else switch(D){case ki:n.blendFuncSeparate(770,771,1,771);break;case $o:n.blendFunc(770,1);break;case Pl:n.blendFuncSeparate(0,769,0,1);break;case Rl:n.blendFunc(0,768);break;default:console.error("THREE.WebGLState: Invalid blending: ",D);break}T=null,S=null,B=null,v=null,w=D,L=pt}return}Le=Le||Z,Xe=Xe||ge,lt=lt||Ae,(Z!==y||Le!==R)&&(n.blendEquationSeparate(b[Z],b[Le]),y=Z,R=Le),(ge!==T||Ae!==S||Xe!==B||lt!==v)&&(n.blendFuncSeparate(A[ge],A[Ae],A[Xe],A[lt]),T=ge,S=Ae,B=Xe,v=lt),w=D,L=!1}function X(D,Z){D.side===Ra?ie(2884):ae(2884);let ge=D.side===Vt;Z&&(ge=!ge),K(ge),D.blending===ki&&D.transparent===!1?H(Nn):H(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.premultipliedAlpha),l.setFunc(D.depthFunc),l.setTest(D.depthTest),l.setMask(D.depthWrite),o.setMask(D.colorWrite);const Ae=D.stencilWrite;c.setTest(Ae),Ae&&(c.setMask(D.stencilWriteMask),c.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),c.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),re(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?ae(32926):ie(32926)}function K(D){O!==D&&(D?n.frontFace(2304):n.frontFace(2305),O=D)}function le(D){D!==ym?(ae(2884),D!==$&&(D===Ll?n.cullFace(1029):D===Mm?n.cullFace(1028):n.cullFace(1032))):ie(2884),$=D}function pe(D){D!==he&&(se&&n.lineWidth(D),he=D)}function re(D,Z,ge){D?(ae(32823),(z!==Z||U!==ge)&&(n.polygonOffset(Z,ge),z=Z,U=ge)):ie(32823)}function me(D){D?ae(3089):ie(3089)}function oe(D){D===void 0&&(D=33984+ee-1),de!==D&&(n.activeTexture(D),de=D)}function M(D,Z,ge){ge===void 0&&(de===null?ge=33984+ee-1:ge=de);let Ae=ue[ge];Ae===void 0&&(Ae={type:void 0,texture:void 0},ue[ge]=Ae),(Ae.type!==D||Ae.texture!==Z)&&(de!==ge&&(n.activeTexture(ge),de=ge),n.bindTexture(D,Z||P[D]),Ae.type=D,Ae.texture=Z)}function x(){const D=ue[de];D!==void 0&&D.type!==void 0&&(n.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function F(){try{n.compressedTexImage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function j(){try{n.compressedTexImage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Q(){try{n.texSubImage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function ce(){try{n.texSubImage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Me(){try{n.compressedTexSubImage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function C(){try{n.compressedTexSubImage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function N(){try{n.texStorage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function be(){try{n.texStorage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Te(){try{n.texImage2D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Se(){try{n.texImage3D.apply(n,arguments)}catch(D){console.error("THREE.WebGLState:",D)}}function Ce(D){fe.equals(D)===!1&&(n.scissor(D.x,D.y,D.z,D.w),fe.copy(D))}function we(D){_e.equals(D)===!1&&(n.viewport(D.x,D.y,D.z,D.w),_e.copy(D))}function Re(D,Z){let ge=f.get(Z);ge===void 0&&(ge=new WeakMap,f.set(Z,ge));let Ae=ge.get(D);Ae===void 0&&(Ae=n.getUniformBlockIndex(Z,D.name),ge.set(D,Ae))}function ze(D,Z){const Ae=f.get(Z).get(D);u.get(Z)!==Ae&&(n.uniformBlockBinding(Z,Ae,D.__bindingPointIndex),u.set(Z,Ae))}function Ye(){n.disable(3042),n.disable(2884),n.disable(2929),n.disable(32823),n.disable(3089),n.disable(2960),n.disable(32926),n.blendEquation(32774),n.blendFunc(1,0),n.blendFuncSeparate(1,0,1,0),n.colorMask(!0,!0,!0,!0),n.clearColor(0,0,0,0),n.depthMask(!0),n.depthFunc(513),n.clearDepth(1),n.stencilMask(4294967295),n.stencilFunc(519,0,4294967295),n.stencilOp(7680,7680,7680),n.clearStencil(0),n.cullFace(1029),n.frontFace(2305),n.polygonOffset(0,0),n.activeTexture(33984),n.bindFramebuffer(36160,null),i===!0&&(n.bindFramebuffer(36009,null),n.bindFramebuffer(36008,null)),n.useProgram(null),n.lineWidth(1),n.scissor(0,0,n.canvas.width,n.canvas.height),n.viewport(0,0,n.canvas.width,n.canvas.height),h={},de=null,ue={},m={},g=new WeakMap,p=[],d=null,_=!1,w=null,y=null,T=null,S=null,R=null,B=null,v=null,L=!1,O=null,$=null,he=null,z=null,U=null,fe.set(0,0,n.canvas.width,n.canvas.height),_e.set(0,0,n.canvas.width,n.canvas.height),o.reset(),l.reset(),c.reset()}return{buffers:{color:o,depth:l,stencil:c},enable:ae,disable:ie,bindFramebuffer:ve,drawBuffers:xe,useProgram:Ee,setBlending:H,setMaterial:X,setFlipSided:K,setCullFace:le,setLineWidth:pe,setPolygonOffset:re,setScissorTest:me,activeTexture:oe,bindTexture:M,unbindTexture:x,compressedTexImage2D:F,compressedTexImage3D:j,texImage2D:Te,texImage3D:Se,updateUBOMapping:Re,uniformBlockBinding:ze,texStorage2D:N,texStorage3D:be,texSubImage2D:Q,texSubImage3D:ce,compressedTexSubImage2D:Me,compressedTexSubImage3D:C,scissor:Ce,viewport:we,reset:Ye}}function oy(n,e,t,i,r,s,a){const o=r.isWebGL2,l=r.maxTextures,c=r.maxCubemapSize,u=r.maxTextureSize,f=r.maxSamples,h=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,m=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),g=new WeakMap;let p;const d=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function w(M,x){return _?new OffscreenCanvas(M,x):Ar("canvas")}function y(M,x,F,j){let Q=1;if((M.width>j||M.height>j)&&(Q=j/Math.max(M.width,M.height)),Q<1||x===!0)if(typeof HTMLImageElement<"u"&&M instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&M instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&M instanceof ImageBitmap){const ce=x?na:Math.floor,Me=ce(Q*M.width),C=ce(Q*M.height);p===void 0&&(p=w(Me,C));const N=F?w(Me,C):p;return N.width=Me,N.height=C,N.getContext("2d").drawImage(M,0,0,Me,C),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+M.width+"x"+M.height+") to ("+Me+"x"+C+")."),N}else return"data"in M&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+M.width+"x"+M.height+")."),M;return M}function T(M){return sc(M.width)&&sc(M.height)}function S(M){return o?!1:M.wrapS!==$t||M.wrapT!==$t||M.minFilter!==St&&M.minFilter!==zt}function R(M,x){return M.generateMipmaps&&x&&M.minFilter!==St&&M.minFilter!==zt}function B(M){n.generateMipmap(M)}function v(M,x,F,j,Q=!1){if(o===!1)return x;if(M!==null){if(n[M]!==void 0)return n[M];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+M+"'")}let ce=x;return x===6403&&(F===5126&&(ce=33326),F===5131&&(ce=33325),F===5121&&(ce=33321)),x===33319&&(F===5126&&(ce=33328),F===5131&&(ce=33327),F===5121&&(ce=33323)),x===6408&&(F===5126&&(ce=34836),F===5131&&(ce=34842),F===5121&&(ce=j===$e&&Q===!1?35907:32856),F===32819&&(ce=32854),F===32820&&(ce=32855)),(ce===33325||ce===33326||ce===33327||ce===33328||ce===34842||ce===34836)&&e.get("EXT_color_buffer_float"),ce}function L(M,x,F){return R(M,F)===!0||M.isFramebufferTexture&&M.minFilter!==St&&M.minFilter!==zt?Math.log2(Math.max(x.width,x.height))+1:M.mipmaps!==void 0&&M.mipmaps.length>0?M.mipmaps.length:M.isCompressedTexture&&Array.isArray(M.image)?x.mipmaps.length:1}function O(M){return M===St||M===Fl||M===Zs?9728:9729}function $(M){const x=M.target;x.removeEventListener("dispose",$),z(x),x.isVideoTexture&&g.delete(x)}function he(M){const x=M.target;x.removeEventListener("dispose",he),ee(x)}function z(M){const x=i.get(M);if(x.__webglInit===void 0)return;const F=M.source,j=d.get(F);if(j){const Q=j[x.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&U(M),Object.keys(j).length===0&&d.delete(F)}i.remove(M)}function U(M){const x=i.get(M);n.deleteTexture(x.__webglTexture);const F=M.source,j=d.get(F);delete j[x.__cacheKey],a.memory.textures--}function ee(M){const x=M.texture,F=i.get(M),j=i.get(x);if(j.__webglTexture!==void 0&&(n.deleteTexture(j.__webglTexture),a.memory.textures--),M.depthTexture&&M.depthTexture.dispose(),M.isWebGLCubeRenderTarget)for(let Q=0;Q<6;Q++)n.deleteFramebuffer(F.__webglFramebuffer[Q]),F.__webglDepthbuffer&&n.deleteRenderbuffer(F.__webglDepthbuffer[Q]);else{if(n.deleteFramebuffer(F.__webglFramebuffer),F.__webglDepthbuffer&&n.deleteRenderbuffer(F.__webglDepthbuffer),F.__webglMultisampledFramebuffer&&n.deleteFramebuffer(F.__webglMultisampledFramebuffer),F.__webglColorRenderbuffer)for(let Q=0;Q<F.__webglColorRenderbuffer.length;Q++)F.__webglColorRenderbuffer[Q]&&n.deleteRenderbuffer(F.__webglColorRenderbuffer[Q]);F.__webglDepthRenderbuffer&&n.deleteRenderbuffer(F.__webglDepthRenderbuffer)}if(M.isWebGLMultipleRenderTargets)for(let Q=0,ce=x.length;Q<ce;Q++){const Me=i.get(x[Q]);Me.__webglTexture&&(n.deleteTexture(Me.__webglTexture),a.memory.textures--),i.remove(x[Q])}i.remove(x),i.remove(M)}let se=0;function te(){se=0}function W(){const M=se;return M>=l&&console.warn("THREE.WebGLTextures: Trying to use "+M+" texture units while this GPU supports only "+l),se+=1,M}function de(M){const x=[];return x.push(M.wrapS),x.push(M.wrapT),x.push(M.wrapR||0),x.push(M.magFilter),x.push(M.minFilter),x.push(M.anisotropy),x.push(M.internalFormat),x.push(M.format),x.push(M.type),x.push(M.generateMipmaps),x.push(M.premultiplyAlpha),x.push(M.flipY),x.push(M.unpackAlignment),x.push(M.encoding),x.join()}function ue(M,x){const F=i.get(M);if(M.isVideoTexture&&me(M),M.isRenderTargetTexture===!1&&M.version>0&&F.__version!==M.version){const j=M.image;if(j===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(j.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{ie(F,M,x);return}}t.bindTexture(3553,F.__webglTexture,33984+x)}function q(M,x){const F=i.get(M);if(M.version>0&&F.__version!==M.version){ie(F,M,x);return}t.bindTexture(35866,F.__webglTexture,33984+x)}function Y(M,x){const F=i.get(M);if(M.version>0&&F.__version!==M.version){ie(F,M,x);return}t.bindTexture(32879,F.__webglTexture,33984+x)}function fe(M,x){const F=i.get(M);if(M.version>0&&F.__version!==M.version){ve(F,M,x);return}t.bindTexture(34067,F.__webglTexture,33984+x)}const _e={[Qo]:10497,[$t]:33071,[ea]:33648},I={[St]:9728,[Fl]:9984,[Zs]:9986,[zt]:9729,[$m]:9985,[wr]:9987};function P(M,x,F){if(F?(n.texParameteri(M,10242,_e[x.wrapS]),n.texParameteri(M,10243,_e[x.wrapT]),(M===32879||M===35866)&&n.texParameteri(M,32882,_e[x.wrapR]),n.texParameteri(M,10240,I[x.magFilter]),n.texParameteri(M,10241,I[x.minFilter])):(n.texParameteri(M,10242,33071),n.texParameteri(M,10243,33071),(M===32879||M===35866)&&n.texParameteri(M,32882,33071),(x.wrapS!==$t||x.wrapT!==$t)&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.wrapS and Texture.wrapT should be set to THREE.ClampToEdgeWrapping."),n.texParameteri(M,10240,O(x.magFilter)),n.texParameteri(M,10241,O(x.minFilter)),x.minFilter!==St&&x.minFilter!==zt&&console.warn("THREE.WebGLRenderer: Texture is not power of two. Texture.minFilter should be set to THREE.NearestFilter or THREE.LinearFilter.")),e.has("EXT_texture_filter_anisotropic")===!0){const j=e.get("EXT_texture_filter_anisotropic");if(x.magFilter===St||x.minFilter!==Zs&&x.minFilter!==wr||x.type===ni&&e.has("OES_texture_float_linear")===!1||o===!1&&x.type===Er&&e.has("OES_texture_half_float_linear")===!1)return;(x.anisotropy>1||i.get(x).__currentAnisotropy)&&(n.texParameterf(M,j.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(x.anisotropy,r.getMaxAnisotropy())),i.get(x).__currentAnisotropy=x.anisotropy)}}function ae(M,x){let F=!1;M.__webglInit===void 0&&(M.__webglInit=!0,x.addEventListener("dispose",$));const j=x.source;let Q=d.get(j);Q===void 0&&(Q={},d.set(j,Q));const ce=de(x);if(ce!==M.__cacheKey){Q[ce]===void 0&&(Q[ce]={texture:n.createTexture(),usedTimes:0},a.memory.textures++,F=!0),Q[ce].usedTimes++;const Me=Q[M.__cacheKey];Me!==void 0&&(Q[M.__cacheKey].usedTimes--,Me.usedTimes===0&&U(x)),M.__cacheKey=ce,M.__webglTexture=Q[ce].texture}return F}function ie(M,x,F){let j=3553;(x.isDataArrayTexture||x.isCompressedArrayTexture)&&(j=35866),x.isData3DTexture&&(j=32879);const Q=ae(M,x),ce=x.source;t.bindTexture(j,M.__webglTexture,33984+F);const Me=i.get(ce);if(ce.version!==Me.__version||Q===!0){t.activeTexture(33984+F),n.pixelStorei(37440,x.flipY),n.pixelStorei(37441,x.premultiplyAlpha),n.pixelStorei(3317,x.unpackAlignment),n.pixelStorei(37443,0);const C=S(x)&&T(x.image)===!1;let N=y(x.image,C,!1,u);N=oe(x,N);const be=T(N)||o,Te=s.convert(x.format,x.encoding);let Se=s.convert(x.type),Ce=v(x.internalFormat,Te,Se,x.encoding,x.isVideoTexture);P(j,x,be);let we;const Re=x.mipmaps,ze=o&&x.isVideoTexture!==!0,Ye=Me.__version===void 0||Q===!0,D=L(x,N,be);if(x.isDepthTexture)Ce=6402,o?x.type===ni?Ce=36012:x.type===ti?Ce=33190:x.type===Gi?Ce=35056:Ce=33189:x.type===ni&&console.error("WebGLRenderer: Floating point depth texture requires WebGL2."),x.format===si&&Ce===6402&&x.type!==lf&&x.type!==ti&&(console.warn("THREE.WebGLRenderer: Use UnsignedShortType or UnsignedIntType for DepthFormat DepthTexture."),x.type=ti,Se=s.convert(x.type)),x.format===Yi&&Ce===6402&&(Ce=34041,x.type!==Gi&&(console.warn("THREE.WebGLRenderer: Use UnsignedInt248Type for DepthStencilFormat DepthTexture."),x.type=Gi,Se=s.convert(x.type))),Ye&&(ze?t.texStorage2D(3553,1,Ce,N.width,N.height):t.texImage2D(3553,0,Ce,N.width,N.height,0,Te,Se,null));else if(x.isDataTexture)if(Re.length>0&&be){ze&&Ye&&t.texStorage2D(3553,D,Ce,Re[0].width,Re[0].height);for(let Z=0,ge=Re.length;Z<ge;Z++)we=Re[Z],ze?t.texSubImage2D(3553,Z,0,0,we.width,we.height,Te,Se,we.data):t.texImage2D(3553,Z,Ce,we.width,we.height,0,Te,Se,we.data);x.generateMipmaps=!1}else ze?(Ye&&t.texStorage2D(3553,D,Ce,N.width,N.height),t.texSubImage2D(3553,0,0,0,N.width,N.height,Te,Se,N.data)):t.texImage2D(3553,0,Ce,N.width,N.height,0,Te,Se,N.data);else if(x.isCompressedTexture)if(x.isCompressedArrayTexture){ze&&Ye&&t.texStorage3D(35866,D,Ce,Re[0].width,Re[0].height,N.depth);for(let Z=0,ge=Re.length;Z<ge;Z++)we=Re[Z],x.format!==Kt?Te!==null?ze?t.compressedTexSubImage3D(35866,Z,0,0,0,we.width,we.height,N.depth,Te,we.data,0,0):t.compressedTexImage3D(35866,Z,Ce,we.width,we.height,N.depth,0,we.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ze?t.texSubImage3D(35866,Z,0,0,0,we.width,we.height,N.depth,Te,Se,we.data):t.texImage3D(35866,Z,Ce,we.width,we.height,N.depth,0,Te,Se,we.data)}else{ze&&Ye&&t.texStorage2D(3553,D,Ce,Re[0].width,Re[0].height);for(let Z=0,ge=Re.length;Z<ge;Z++)we=Re[Z],x.format!==Kt?Te!==null?ze?t.compressedTexSubImage2D(3553,Z,0,0,we.width,we.height,Te,we.data):t.compressedTexImage2D(3553,Z,Ce,we.width,we.height,0,we.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):ze?t.texSubImage2D(3553,Z,0,0,we.width,we.height,Te,Se,we.data):t.texImage2D(3553,Z,Ce,we.width,we.height,0,Te,Se,we.data)}else if(x.isDataArrayTexture)ze?(Ye&&t.texStorage3D(35866,D,Ce,N.width,N.height,N.depth),t.texSubImage3D(35866,0,0,0,0,N.width,N.height,N.depth,Te,Se,N.data)):t.texImage3D(35866,0,Ce,N.width,N.height,N.depth,0,Te,Se,N.data);else if(x.isData3DTexture)ze?(Ye&&t.texStorage3D(32879,D,Ce,N.width,N.height,N.depth),t.texSubImage3D(32879,0,0,0,0,N.width,N.height,N.depth,Te,Se,N.data)):t.texImage3D(32879,0,Ce,N.width,N.height,N.depth,0,Te,Se,N.data);else if(x.isFramebufferTexture){if(Ye)if(ze)t.texStorage2D(3553,D,Ce,N.width,N.height);else{let Z=N.width,ge=N.height;for(let Ae=0;Ae<D;Ae++)t.texImage2D(3553,Ae,Ce,Z,ge,0,Te,Se,null),Z>>=1,ge>>=1}}else if(Re.length>0&&be){ze&&Ye&&t.texStorage2D(3553,D,Ce,Re[0].width,Re[0].height);for(let Z=0,ge=Re.length;Z<ge;Z++)we=Re[Z],ze?t.texSubImage2D(3553,Z,0,0,Te,Se,we):t.texImage2D(3553,Z,Ce,Te,Se,we);x.generateMipmaps=!1}else ze?(Ye&&t.texStorage2D(3553,D,Ce,N.width,N.height),t.texSubImage2D(3553,0,0,0,Te,Se,N)):t.texImage2D(3553,0,Ce,Te,Se,N);R(x,be)&&B(j),Me.__version=ce.version,x.onUpdate&&x.onUpdate(x)}M.__version=x.version}function ve(M,x,F){if(x.image.length!==6)return;const j=ae(M,x),Q=x.source;t.bindTexture(34067,M.__webglTexture,33984+F);const ce=i.get(Q);if(Q.version!==ce.__version||j===!0){t.activeTexture(33984+F),n.pixelStorei(37440,x.flipY),n.pixelStorei(37441,x.premultiplyAlpha),n.pixelStorei(3317,x.unpackAlignment),n.pixelStorei(37443,0);const Me=x.isCompressedTexture||x.image[0].isCompressedTexture,C=x.image[0]&&x.image[0].isDataTexture,N=[];for(let Z=0;Z<6;Z++)!Me&&!C?N[Z]=y(x.image[Z],!1,!0,c):N[Z]=C?x.image[Z].image:x.image[Z],N[Z]=oe(x,N[Z]);const be=N[0],Te=T(be)||o,Se=s.convert(x.format,x.encoding),Ce=s.convert(x.type),we=v(x.internalFormat,Se,Ce,x.encoding),Re=o&&x.isVideoTexture!==!0,ze=ce.__version===void 0||j===!0;let Ye=L(x,be,Te);P(34067,x,Te);let D;if(Me){Re&&ze&&t.texStorage2D(34067,Ye,we,be.width,be.height);for(let Z=0;Z<6;Z++){D=N[Z].mipmaps;for(let ge=0;ge<D.length;ge++){const Ae=D[ge];x.format!==Kt?Se!==null?Re?t.compressedTexSubImage2D(34069+Z,ge,0,0,Ae.width,Ae.height,Se,Ae.data):t.compressedTexImage2D(34069+Z,ge,we,Ae.width,Ae.height,0,Ae.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Re?t.texSubImage2D(34069+Z,ge,0,0,Ae.width,Ae.height,Se,Ce,Ae.data):t.texImage2D(34069+Z,ge,we,Ae.width,Ae.height,0,Se,Ce,Ae.data)}}}else{D=x.mipmaps,Re&&ze&&(D.length>0&&Ye++,t.texStorage2D(34067,Ye,we,N[0].width,N[0].height));for(let Z=0;Z<6;Z++)if(C){Re?t.texSubImage2D(34069+Z,0,0,0,N[Z].width,N[Z].height,Se,Ce,N[Z].data):t.texImage2D(34069+Z,0,we,N[Z].width,N[Z].height,0,Se,Ce,N[Z].data);for(let ge=0;ge<D.length;ge++){const Le=D[ge].image[Z].image;Re?t.texSubImage2D(34069+Z,ge+1,0,0,Le.width,Le.height,Se,Ce,Le.data):t.texImage2D(34069+Z,ge+1,we,Le.width,Le.height,0,Se,Ce,Le.data)}}else{Re?t.texSubImage2D(34069+Z,0,0,0,Se,Ce,N[Z]):t.texImage2D(34069+Z,0,we,Se,Ce,N[Z]);for(let ge=0;ge<D.length;ge++){const Ae=D[ge];Re?t.texSubImage2D(34069+Z,ge+1,0,0,Se,Ce,Ae.image[Z]):t.texImage2D(34069+Z,ge+1,we,Se,Ce,Ae.image[Z])}}}R(x,Te)&&B(34067),ce.__version=Q.version,x.onUpdate&&x.onUpdate(x)}M.__version=x.version}function xe(M,x,F,j,Q){const ce=s.convert(F.format,F.encoding),Me=s.convert(F.type),C=v(F.internalFormat,ce,Me,F.encoding);i.get(x).__hasExternalTextures||(Q===32879||Q===35866?t.texImage3D(Q,0,C,x.width,x.height,x.depth,0,ce,Me,null):t.texImage2D(Q,0,C,x.width,x.height,0,ce,Me,null)),t.bindFramebuffer(36160,M),re(x)?h.framebufferTexture2DMultisampleEXT(36160,j,Q,i.get(F).__webglTexture,0,pe(x)):(Q===3553||Q>=34069&&Q<=34074)&&n.framebufferTexture2D(36160,j,Q,i.get(F).__webglTexture,0),t.bindFramebuffer(36160,null)}function Ee(M,x,F){if(n.bindRenderbuffer(36161,M),x.depthBuffer&&!x.stencilBuffer){let j=33189;if(F||re(x)){const Q=x.depthTexture;Q&&Q.isDepthTexture&&(Q.type===ni?j=36012:Q.type===ti&&(j=33190));const ce=pe(x);re(x)?h.renderbufferStorageMultisampleEXT(36161,ce,j,x.width,x.height):n.renderbufferStorageMultisample(36161,ce,j,x.width,x.height)}else n.renderbufferStorage(36161,j,x.width,x.height);n.framebufferRenderbuffer(36160,36096,36161,M)}else if(x.depthBuffer&&x.stencilBuffer){const j=pe(x);F&&re(x)===!1?n.renderbufferStorageMultisample(36161,j,35056,x.width,x.height):re(x)?h.renderbufferStorageMultisampleEXT(36161,j,35056,x.width,x.height):n.renderbufferStorage(36161,34041,x.width,x.height),n.framebufferRenderbuffer(36160,33306,36161,M)}else{const j=x.isWebGLMultipleRenderTargets===!0?x.texture:[x.texture];for(let Q=0;Q<j.length;Q++){const ce=j[Q],Me=s.convert(ce.format,ce.encoding),C=s.convert(ce.type),N=v(ce.internalFormat,Me,C,ce.encoding),be=pe(x);F&&re(x)===!1?n.renderbufferStorageMultisample(36161,be,N,x.width,x.height):re(x)?h.renderbufferStorageMultisampleEXT(36161,be,N,x.width,x.height):n.renderbufferStorage(36161,N,x.width,x.height)}}n.bindRenderbuffer(36161,null)}function b(M,x){if(x&&x.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(36160,M),!(x.depthTexture&&x.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!i.get(x.depthTexture).__webglTexture||x.depthTexture.image.width!==x.width||x.depthTexture.image.height!==x.height)&&(x.depthTexture.image.width=x.width,x.depthTexture.image.height=x.height,x.depthTexture.needsUpdate=!0),ue(x.depthTexture,0);const j=i.get(x.depthTexture).__webglTexture,Q=pe(x);if(x.depthTexture.format===si)re(x)?h.framebufferTexture2DMultisampleEXT(36160,36096,3553,j,0,Q):n.framebufferTexture2D(36160,36096,3553,j,0);else if(x.depthTexture.format===Yi)re(x)?h.framebufferTexture2DMultisampleEXT(36160,33306,3553,j,0,Q):n.framebufferTexture2D(36160,33306,3553,j,0);else throw new Error("Unknown depthTexture format")}function A(M){const x=i.get(M),F=M.isWebGLCubeRenderTarget===!0;if(M.depthTexture&&!x.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");b(x.__webglFramebuffer,M)}else if(F){x.__webglDepthbuffer=[];for(let j=0;j<6;j++)t.bindFramebuffer(36160,x.__webglFramebuffer[j]),x.__webglDepthbuffer[j]=n.createRenderbuffer(),Ee(x.__webglDepthbuffer[j],M,!1)}else t.bindFramebuffer(36160,x.__webglFramebuffer),x.__webglDepthbuffer=n.createRenderbuffer(),Ee(x.__webglDepthbuffer,M,!1);t.bindFramebuffer(36160,null)}function H(M,x,F){const j=i.get(M);x!==void 0&&xe(j.__webglFramebuffer,M,M.texture,36064,3553),F!==void 0&&A(M)}function X(M){const x=M.texture,F=i.get(M),j=i.get(x);M.addEventListener("dispose",he),M.isWebGLMultipleRenderTargets!==!0&&(j.__webglTexture===void 0&&(j.__webglTexture=n.createTexture()),j.__version=x.version,a.memory.textures++);const Q=M.isWebGLCubeRenderTarget===!0,ce=M.isWebGLMultipleRenderTargets===!0,Me=T(M)||o;if(Q){F.__webglFramebuffer=[];for(let C=0;C<6;C++)F.__webglFramebuffer[C]=n.createFramebuffer()}else{if(F.__webglFramebuffer=n.createFramebuffer(),ce)if(r.drawBuffers){const C=M.texture;for(let N=0,be=C.length;N<be;N++){const Te=i.get(C[N]);Te.__webglTexture===void 0&&(Te.__webglTexture=n.createTexture(),a.memory.textures++)}}else console.warn("THREE.WebGLRenderer: WebGLMultipleRenderTargets can only be used with WebGL2 or WEBGL_draw_buffers extension.");if(o&&M.samples>0&&re(M)===!1){const C=ce?x:[x];F.__webglMultisampledFramebuffer=n.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(36160,F.__webglMultisampledFramebuffer);for(let N=0;N<C.length;N++){const be=C[N];F.__webglColorRenderbuffer[N]=n.createRenderbuffer(),n.bindRenderbuffer(36161,F.__webglColorRenderbuffer[N]);const Te=s.convert(be.format,be.encoding),Se=s.convert(be.type),Ce=v(be.internalFormat,Te,Se,be.encoding,M.isXRRenderTarget===!0),we=pe(M);n.renderbufferStorageMultisample(36161,we,Ce,M.width,M.height),n.framebufferRenderbuffer(36160,36064+N,36161,F.__webglColorRenderbuffer[N])}n.bindRenderbuffer(36161,null),M.depthBuffer&&(F.__webglDepthRenderbuffer=n.createRenderbuffer(),Ee(F.__webglDepthRenderbuffer,M,!0)),t.bindFramebuffer(36160,null)}}if(Q){t.bindTexture(34067,j.__webglTexture),P(34067,x,Me);for(let C=0;C<6;C++)xe(F.__webglFramebuffer[C],M,x,36064,34069+C);R(x,Me)&&B(34067),t.unbindTexture()}else if(ce){const C=M.texture;for(let N=0,be=C.length;N<be;N++){const Te=C[N],Se=i.get(Te);t.bindTexture(3553,Se.__webglTexture),P(3553,Te,Me),xe(F.__webglFramebuffer,M,Te,36064+N,3553),R(Te,Me)&&B(3553)}t.unbindTexture()}else{let C=3553;(M.isWebGL3DRenderTarget||M.isWebGLArrayRenderTarget)&&(o?C=M.isWebGL3DRenderTarget?32879:35866:console.error("THREE.WebGLTextures: THREE.Data3DTexture and THREE.DataArrayTexture only supported with WebGL2.")),t.bindTexture(C,j.__webglTexture),P(C,x,Me),xe(F.__webglFramebuffer,M,x,36064,C),R(x,Me)&&B(C),t.unbindTexture()}M.depthBuffer&&A(M)}function K(M){const x=T(M)||o,F=M.isWebGLMultipleRenderTargets===!0?M.texture:[M.texture];for(let j=0,Q=F.length;j<Q;j++){const ce=F[j];if(R(ce,x)){const Me=M.isWebGLCubeRenderTarget?34067:3553,C=i.get(ce).__webglTexture;t.bindTexture(Me,C),B(Me),t.unbindTexture()}}}function le(M){if(o&&M.samples>0&&re(M)===!1){const x=M.isWebGLMultipleRenderTargets?M.texture:[M.texture],F=M.width,j=M.height;let Q=16384;const ce=[],Me=M.stencilBuffer?33306:36096,C=i.get(M),N=M.isWebGLMultipleRenderTargets===!0;if(N)for(let be=0;be<x.length;be++)t.bindFramebuffer(36160,C.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(36160,36064+be,36161,null),t.bindFramebuffer(36160,C.__webglFramebuffer),n.framebufferTexture2D(36009,36064+be,3553,null,0);t.bindFramebuffer(36008,C.__webglMultisampledFramebuffer),t.bindFramebuffer(36009,C.__webglFramebuffer);for(let be=0;be<x.length;be++){ce.push(36064+be),M.depthBuffer&&ce.push(Me);const Te=C.__ignoreDepthValues!==void 0?C.__ignoreDepthValues:!1;if(Te===!1&&(M.depthBuffer&&(Q|=256),M.stencilBuffer&&(Q|=1024)),N&&n.framebufferRenderbuffer(36008,36064,36161,C.__webglColorRenderbuffer[be]),Te===!0&&(n.invalidateFramebuffer(36008,[Me]),n.invalidateFramebuffer(36009,[Me])),N){const Se=i.get(x[be]).__webglTexture;n.framebufferTexture2D(36009,36064,3553,Se,0)}n.blitFramebuffer(0,0,F,j,0,0,F,j,Q,9728),m&&n.invalidateFramebuffer(36008,ce)}if(t.bindFramebuffer(36008,null),t.bindFramebuffer(36009,null),N)for(let be=0;be<x.length;be++){t.bindFramebuffer(36160,C.__webglMultisampledFramebuffer),n.framebufferRenderbuffer(36160,36064+be,36161,C.__webglColorRenderbuffer[be]);const Te=i.get(x[be]).__webglTexture;t.bindFramebuffer(36160,C.__webglFramebuffer),n.framebufferTexture2D(36009,36064+be,3553,Te,0)}t.bindFramebuffer(36009,C.__webglMultisampledFramebuffer)}}function pe(M){return Math.min(f,M.samples)}function re(M){const x=i.get(M);return o&&M.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&x.__useRenderToTexture!==!1}function me(M){const x=a.render.frame;g.get(M)!==x&&(g.set(M,x),M.update())}function oe(M,x){const F=M.encoding,j=M.format,Q=M.type;return M.isCompressedTexture===!0||M.isVideoTexture===!0||M.format===ta||F!==ui&&(F===$e?o===!1?e.has("EXT_sRGB")===!0&&j===Kt?(M.format=ta,M.minFilter=zt,M.generateMipmaps=!1):x=ff.sRGBToLinear(x):(j!==Kt||Q!==ci)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture encoding:",F)),x}this.allocateTextureUnit=W,this.resetTextureUnits=te,this.setTexture2D=ue,this.setTexture2DArray=q,this.setTexture3D=Y,this.setTextureCube=fe,this.rebindTextures=H,this.setupRenderTarget=X,this.updateRenderTargetMipmap=K,this.updateMultisampleRenderTarget=le,this.setupDepthRenderbuffer=A,this.setupFrameBufferTexture=xe,this.useMultisampledRTT=re}function ay(n,e,t){const i=t.isWebGL2;function r(s,a=null){let o;if(s===ci)return 5121;if(s===Qm)return 32819;if(s===eg)return 32820;if(s===Km)return 5120;if(s===Zm)return 5122;if(s===lf)return 5123;if(s===Jm)return 5124;if(s===ti)return 5125;if(s===ni)return 5126;if(s===Er)return i?5131:(o=e.get("OES_texture_half_float"),o!==null?o.HALF_FLOAT_OES:null);if(s===tg)return 6406;if(s===Kt)return 6408;if(s===ig)return 6409;if(s===rg)return 6410;if(s===si)return 6402;if(s===Yi)return 34041;if(s===ng)return console.warn("THREE.WebGLRenderer: THREE.RGBFormat has been removed. Use THREE.RGBAFormat instead. https://github.com/mrdoob/three.js/pull/23228"),6408;if(s===ta)return o=e.get("EXT_sRGB"),o!==null?o.SRGB_ALPHA_EXT:null;if(s===sg)return 6403;if(s===og)return 36244;if(s===ag)return 33319;if(s===lg)return 33320;if(s===cg)return 36249;if(s===Js||s===Qs||s===eo||s===to)if(a===$e)if(o=e.get("WEBGL_compressed_texture_s3tc_srgb"),o!==null){if(s===Js)return o.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(s===Qs)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(s===eo)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(s===to)return o.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(o=e.get("WEBGL_compressed_texture_s3tc"),o!==null){if(s===Js)return o.COMPRESSED_RGB_S3TC_DXT1_EXT;if(s===Qs)return o.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(s===eo)return o.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(s===to)return o.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(s===Ol||s===Nl||s===Ul||s===zl)if(o=e.get("WEBGL_compressed_texture_pvrtc"),o!==null){if(s===Ol)return o.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(s===Nl)return o.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(s===Ul)return o.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(s===zl)return o.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(s===ug)return o=e.get("WEBGL_compressed_texture_etc1"),o!==null?o.COMPRESSED_RGB_ETC1_WEBGL:null;if(s===Bl||s===kl)if(o=e.get("WEBGL_compressed_texture_etc"),o!==null){if(s===Bl)return a===$e?o.COMPRESSED_SRGB8_ETC2:o.COMPRESSED_RGB8_ETC2;if(s===kl)return a===$e?o.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:o.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(s===Gl||s===Hl||s===Vl||s===Wl||s===ql||s===Xl||s===jl||s===Yl||s===$l||s===Kl||s===Zl||s===Jl||s===Ql||s===ec)if(o=e.get("WEBGL_compressed_texture_astc"),o!==null){if(s===Gl)return a===$e?o.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:o.COMPRESSED_RGBA_ASTC_4x4_KHR;if(s===Hl)return a===$e?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:o.COMPRESSED_RGBA_ASTC_5x4_KHR;if(s===Vl)return a===$e?o.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:o.COMPRESSED_RGBA_ASTC_5x5_KHR;if(s===Wl)return a===$e?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:o.COMPRESSED_RGBA_ASTC_6x5_KHR;if(s===ql)return a===$e?o.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:o.COMPRESSED_RGBA_ASTC_6x6_KHR;if(s===Xl)return a===$e?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:o.COMPRESSED_RGBA_ASTC_8x5_KHR;if(s===jl)return a===$e?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:o.COMPRESSED_RGBA_ASTC_8x6_KHR;if(s===Yl)return a===$e?o.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:o.COMPRESSED_RGBA_ASTC_8x8_KHR;if(s===$l)return a===$e?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:o.COMPRESSED_RGBA_ASTC_10x5_KHR;if(s===Kl)return a===$e?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:o.COMPRESSED_RGBA_ASTC_10x6_KHR;if(s===Zl)return a===$e?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:o.COMPRESSED_RGBA_ASTC_10x8_KHR;if(s===Jl)return a===$e?o.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:o.COMPRESSED_RGBA_ASTC_10x10_KHR;if(s===Ql)return a===$e?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:o.COMPRESSED_RGBA_ASTC_12x10_KHR;if(s===ec)return a===$e?o.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:o.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(s===tc)if(o=e.get("EXT_texture_compression_bptc"),o!==null){if(s===tc)return a===$e?o.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:o.COMPRESSED_RGBA_BPTC_UNORM_EXT}else return null;return s===Gi?i?34042:(o=e.get("WEBGL_depth_texture"),o!==null?o.UNSIGNED_INT_24_8_WEBGL:null):n[s]!==void 0?n[s]:null}return{convert:r}}class ly extends Bt{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class os extends ht{constructor(){super(),this.isGroup=!0,this.type="Group"}}const cy={type:"move"};class Lo{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new os,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new os,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new V,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new V),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new os,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new V,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new V),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const i of e.hand.values())this._getHandJoint(t,i)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,i){let r=null,s=null,a=null;const o=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){a=!0;for(const p of e.hand.values()){const d=t.getJointPose(p,i),_=this._getHandJoint(c,p);d!==null&&(_.matrix.fromArray(d.transform.matrix),_.matrix.decompose(_.position,_.rotation,_.scale),_.jointRadius=d.radius),_.visible=d!==null}const u=c.joints["index-finger-tip"],f=c.joints["thumb-tip"],h=u.position.distanceTo(f.position),m=.02,g=.005;c.inputState.pinching&&h>m+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&h<=m-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(s=t.getPose(e.gripSpace,i),s!==null&&(l.matrix.fromArray(s.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),s.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(s.linearVelocity)):l.hasLinearVelocity=!1,s.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(s.angularVelocity)):l.hasAngularVelocity=!1));o!==null&&(r=t.getPose(e.targetRaySpace,i),r===null&&s!==null&&(r=s),r!==null&&(o.matrix.fromArray(r.transform.matrix),o.matrix.decompose(o.position,o.rotation,o.scale),r.linearVelocity?(o.hasLinearVelocity=!0,o.linearVelocity.copy(r.linearVelocity)):o.hasLinearVelocity=!1,r.angularVelocity?(o.hasAngularVelocity=!0,o.angularVelocity.copy(r.angularVelocity)):o.hasAngularVelocity=!1,this.dispatchEvent(cy)))}return o!==null&&(o.visible=r!==null),l!==null&&(l.visible=s!==null),c!==null&&(c.visible=a!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const i=new os;i.matrixAutoUpdate=!1,i.visible=!1,e.joints[t.jointName]=i,e.add(i)}return e.joints[t.jointName]}}class uy extends Tt{constructor(e,t,i,r,s,a,o,l,c,u){if(u=u!==void 0?u:si,u!==si&&u!==Yi)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");i===void 0&&u===si&&(i=ti),i===void 0&&u===Yi&&(i=Gi),super(null,r,s,a,o,l,u,i,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=o!==void 0?o:St,this.minFilter=l!==void 0?l:St,this.flipY=!1,this.generateMipmaps=!1}}class fy extends pi{constructor(e,t){super();const i=this;let r=null,s=1,a=null,o="local-floor",l=null,c=null,u=null,f=null,h=null,m=null;const g=t.getContextAttributes();let p=null,d=null;const _=[],w=[],y=new Set,T=new Map,S=new Bt;S.layers.enable(1),S.viewport=new ft;const R=new Bt;R.layers.enable(2),R.viewport=new ft;const B=[S,R],v=new ly;v.layers.enable(1),v.layers.enable(2);let L=null,O=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(q){let Y=_[q];return Y===void 0&&(Y=new Lo,_[q]=Y),Y.getTargetRaySpace()},this.getControllerGrip=function(q){let Y=_[q];return Y===void 0&&(Y=new Lo,_[q]=Y),Y.getGripSpace()},this.getHand=function(q){let Y=_[q];return Y===void 0&&(Y=new Lo,_[q]=Y),Y.getHandSpace()};function $(q){const Y=w.indexOf(q.inputSource);if(Y===-1)return;const fe=_[Y];fe!==void 0&&fe.dispatchEvent({type:q.type,data:q.inputSource})}function he(){r.removeEventListener("select",$),r.removeEventListener("selectstart",$),r.removeEventListener("selectend",$),r.removeEventListener("squeeze",$),r.removeEventListener("squeezestart",$),r.removeEventListener("squeezeend",$),r.removeEventListener("end",he),r.removeEventListener("inputsourceschange",z);for(let q=0;q<_.length;q++){const Y=w[q];Y!==null&&(w[q]=null,_[q].disconnect(Y))}L=null,O=null,e.setRenderTarget(p),h=null,f=null,u=null,r=null,d=null,ue.stop(),i.isPresenting=!1,i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(q){s=q,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(q){o=q,i.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(q){l=q},this.getBaseLayer=function(){return f!==null?f:h},this.getBinding=function(){return u},this.getFrame=function(){return m},this.getSession=function(){return r},this.setSession=async function(q){if(r=q,r!==null){if(p=e.getRenderTarget(),r.addEventListener("select",$),r.addEventListener("selectstart",$),r.addEventListener("selectend",$),r.addEventListener("squeeze",$),r.addEventListener("squeezestart",$),r.addEventListener("squeezeend",$),r.addEventListener("end",he),r.addEventListener("inputsourceschange",z),g.xrCompatible!==!0&&await t.makeXRCompatible(),r.renderState.layers===void 0||e.capabilities.isWebGL2===!1){const Y={antialias:r.renderState.layers===void 0?g.antialias:!0,alpha:g.alpha,depth:g.depth,stencil:g.stencil,framebufferScaleFactor:s};h=new XRWebGLLayer(r,t,Y),r.updateRenderState({baseLayer:h}),d=new fi(h.framebufferWidth,h.framebufferHeight,{format:Kt,type:ci,encoding:e.outputEncoding,stencilBuffer:g.stencil})}else{let Y=null,fe=null,_e=null;g.depth&&(_e=g.stencil?35056:33190,Y=g.stencil?Yi:si,fe=g.stencil?Gi:ti);const I={colorFormat:32856,depthFormat:_e,scaleFactor:s};u=new XRWebGLBinding(r,t),f=u.createProjectionLayer(I),r.updateRenderState({layers:[f]}),d=new fi(f.textureWidth,f.textureHeight,{format:Kt,type:ci,depthTexture:new uy(f.textureWidth,f.textureHeight,fe,void 0,void 0,void 0,void 0,void 0,void 0,Y),stencilBuffer:g.stencil,encoding:e.outputEncoding,samples:g.antialias?4:0});const P=e.properties.get(d);P.__ignoreDepthValues=f.ignoreDepthValues}d.isXRRenderTarget=!0,this.setFoveation(1),l=null,a=await r.requestReferenceSpace(o),ue.setContext(r),ue.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}};function z(q){for(let Y=0;Y<q.removed.length;Y++){const fe=q.removed[Y],_e=w.indexOf(fe);_e>=0&&(w[_e]=null,_[_e].disconnect(fe))}for(let Y=0;Y<q.added.length;Y++){const fe=q.added[Y];let _e=w.indexOf(fe);if(_e===-1){for(let P=0;P<_.length;P++)if(P>=w.length){w.push(fe),_e=P;break}else if(w[P]===null){w[P]=fe,_e=P;break}if(_e===-1)break}const I=_[_e];I&&I.connect(fe)}}const U=new V,ee=new V;function se(q,Y,fe){U.setFromMatrixPosition(Y.matrixWorld),ee.setFromMatrixPosition(fe.matrixWorld);const _e=U.distanceTo(ee),I=Y.projectionMatrix.elements,P=fe.projectionMatrix.elements,ae=I[14]/(I[10]-1),ie=I[14]/(I[10]+1),ve=(I[9]+1)/I[5],xe=(I[9]-1)/I[5],Ee=(I[8]-1)/I[0],b=(P[8]+1)/P[0],A=ae*Ee,H=ae*b,X=_e/(-Ee+b),K=X*-Ee;Y.matrixWorld.decompose(q.position,q.quaternion,q.scale),q.translateX(K),q.translateZ(X),q.matrixWorld.compose(q.position,q.quaternion,q.scale),q.matrixWorldInverse.copy(q.matrixWorld).invert();const le=ae+X,pe=ie+X,re=A-K,me=H+(_e-K),oe=ve*ie/pe*le,M=xe*ie/pe*le;q.projectionMatrix.makePerspective(re,me,oe,M,le,pe)}function te(q,Y){Y===null?q.matrixWorld.copy(q.matrix):q.matrixWorld.multiplyMatrices(Y.matrixWorld,q.matrix),q.matrixWorldInverse.copy(q.matrixWorld).invert()}this.updateCamera=function(q){if(r===null)return;v.near=R.near=S.near=q.near,v.far=R.far=S.far=q.far,(L!==v.near||O!==v.far)&&(r.updateRenderState({depthNear:v.near,depthFar:v.far}),L=v.near,O=v.far);const Y=q.parent,fe=v.cameras;te(v,Y);for(let I=0;I<fe.length;I++)te(fe[I],Y);v.matrixWorld.decompose(v.position,v.quaternion,v.scale),q.matrix.copy(v.matrix),q.matrix.decompose(q.position,q.quaternion,q.scale);const _e=q.children;for(let I=0,P=_e.length;I<P;I++)_e[I].updateMatrixWorld(!0);fe.length===2?se(v,S,R):v.projectionMatrix.copy(S.projectionMatrix)},this.getCamera=function(){return v},this.getFoveation=function(){if(f!==null)return f.fixedFoveation;if(h!==null)return h.fixedFoveation},this.setFoveation=function(q){f!==null&&(f.fixedFoveation=q),h!==null&&h.fixedFoveation!==void 0&&(h.fixedFoveation=q)},this.getPlanes=function(){return y};let W=null;function de(q,Y){if(c=Y.getViewerPose(l||a),m=Y,c!==null){const fe=c.views;h!==null&&(e.setRenderTargetFramebuffer(d,h.framebuffer),e.setRenderTarget(d));let _e=!1;fe.length!==v.cameras.length&&(v.cameras.length=0,_e=!0);for(let I=0;I<fe.length;I++){const P=fe[I];let ae=null;if(h!==null)ae=h.getViewport(P);else{const ve=u.getViewSubImage(f,P);ae=ve.viewport,I===0&&(e.setRenderTargetTextures(d,ve.colorTexture,f.ignoreDepthValues?void 0:ve.depthStencilTexture),e.setRenderTarget(d))}let ie=B[I];ie===void 0&&(ie=new Bt,ie.layers.enable(I),ie.viewport=new ft,B[I]=ie),ie.matrix.fromArray(P.transform.matrix),ie.projectionMatrix.fromArray(P.projectionMatrix),ie.viewport.set(ae.x,ae.y,ae.width,ae.height),I===0&&v.matrix.copy(ie.matrix),_e===!0&&v.cameras.push(ie)}}for(let fe=0;fe<_.length;fe++){const _e=w[fe],I=_[fe];_e!==null&&I!==void 0&&I.update(_e,Y,l||a)}if(W&&W(q,Y),Y.detectedPlanes){i.dispatchEvent({type:"planesdetected",data:Y.detectedPlanes});let fe=null;for(const _e of y)Y.detectedPlanes.has(_e)||(fe===null&&(fe=[]),fe.push(_e));if(fe!==null)for(const _e of fe)y.delete(_e),T.delete(_e),i.dispatchEvent({type:"planeremoved",data:_e});for(const _e of Y.detectedPlanes)if(!y.has(_e))y.add(_e),T.set(_e,Y.lastChangedTime),i.dispatchEvent({type:"planeadded",data:_e});else{const I=T.get(_e);_e.lastChangedTime>I&&(T.set(_e,_e.lastChangedTime),i.dispatchEvent({type:"planechanged",data:_e}))}}m=null}const ue=new bf;ue.setAnimationLoop(de),this.setAnimationLoop=function(q){W=q},this.dispose=function(){}}}function hy(n,e){function t(p,d){d.color.getRGB(p.fogColor.value,vf(n)),d.isFog?(p.fogNear.value=d.near,p.fogFar.value=d.far):d.isFogExp2&&(p.fogDensity.value=d.density)}function i(p,d,_,w,y){d.isMeshBasicMaterial||d.isMeshLambertMaterial?r(p,d):d.isMeshToonMaterial?(r(p,d),u(p,d)):d.isMeshPhongMaterial?(r(p,d),c(p,d)):d.isMeshStandardMaterial?(r(p,d),f(p,d),d.isMeshPhysicalMaterial&&h(p,d,y)):d.isMeshMatcapMaterial?(r(p,d),m(p,d)):d.isMeshDepthMaterial?r(p,d):d.isMeshDistanceMaterial?(r(p,d),g(p,d)):d.isMeshNormalMaterial?r(p,d):d.isLineBasicMaterial?(s(p,d),d.isLineDashedMaterial&&a(p,d)):d.isPointsMaterial?o(p,d,_,w):d.isSpriteMaterial?l(p,d):d.isShadowMaterial?(p.color.value.copy(d.color),p.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function r(p,d){p.opacity.value=d.opacity,d.color&&p.diffuse.value.copy(d.color),d.emissive&&p.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(p.map.value=d.map),d.alphaMap&&(p.alphaMap.value=d.alphaMap),d.bumpMap&&(p.bumpMap.value=d.bumpMap,p.bumpScale.value=d.bumpScale,d.side===Vt&&(p.bumpScale.value*=-1)),d.displacementMap&&(p.displacementMap.value=d.displacementMap,p.displacementScale.value=d.displacementScale,p.displacementBias.value=d.displacementBias),d.emissiveMap&&(p.emissiveMap.value=d.emissiveMap),d.normalMap&&(p.normalMap.value=d.normalMap,p.normalScale.value.copy(d.normalScale),d.side===Vt&&p.normalScale.value.negate()),d.specularMap&&(p.specularMap.value=d.specularMap),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest);const _=e.get(d).envMap;if(_&&(p.envMap.value=_,p.flipEnvMap.value=_.isCubeTexture&&_.isRenderTargetTexture===!1?-1:1,p.reflectivity.value=d.reflectivity,p.ior.value=d.ior,p.refractionRatio.value=d.refractionRatio),d.lightMap){p.lightMap.value=d.lightMap;const T=n.physicallyCorrectLights!==!0?Math.PI:1;p.lightMapIntensity.value=d.lightMapIntensity*T}d.aoMap&&(p.aoMap.value=d.aoMap,p.aoMapIntensity.value=d.aoMapIntensity);let w;d.map?w=d.map:d.specularMap?w=d.specularMap:d.displacementMap?w=d.displacementMap:d.normalMap?w=d.normalMap:d.bumpMap?w=d.bumpMap:d.roughnessMap?w=d.roughnessMap:d.metalnessMap?w=d.metalnessMap:d.alphaMap?w=d.alphaMap:d.emissiveMap?w=d.emissiveMap:d.clearcoatMap?w=d.clearcoatMap:d.clearcoatNormalMap?w=d.clearcoatNormalMap:d.clearcoatRoughnessMap?w=d.clearcoatRoughnessMap:d.iridescenceMap?w=d.iridescenceMap:d.iridescenceThicknessMap?w=d.iridescenceThicknessMap:d.specularIntensityMap?w=d.specularIntensityMap:d.specularColorMap?w=d.specularColorMap:d.transmissionMap?w=d.transmissionMap:d.thicknessMap?w=d.thicknessMap:d.sheenColorMap?w=d.sheenColorMap:d.sheenRoughnessMap&&(w=d.sheenRoughnessMap),w!==void 0&&(w.isWebGLRenderTarget&&(w=w.texture),w.matrixAutoUpdate===!0&&w.updateMatrix(),p.uvTransform.value.copy(w.matrix));let y;d.aoMap?y=d.aoMap:d.lightMap&&(y=d.lightMap),y!==void 0&&(y.isWebGLRenderTarget&&(y=y.texture),y.matrixAutoUpdate===!0&&y.updateMatrix(),p.uv2Transform.value.copy(y.matrix))}function s(p,d){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity}function a(p,d){p.dashSize.value=d.dashSize,p.totalSize.value=d.dashSize+d.gapSize,p.scale.value=d.scale}function o(p,d,_,w){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity,p.size.value=d.size*_,p.scale.value=w*.5,d.map&&(p.map.value=d.map),d.alphaMap&&(p.alphaMap.value=d.alphaMap),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest);let y;d.map?y=d.map:d.alphaMap&&(y=d.alphaMap),y!==void 0&&(y.matrixAutoUpdate===!0&&y.updateMatrix(),p.uvTransform.value.copy(y.matrix))}function l(p,d){p.diffuse.value.copy(d.color),p.opacity.value=d.opacity,p.rotation.value=d.rotation,d.map&&(p.map.value=d.map),d.alphaMap&&(p.alphaMap.value=d.alphaMap),d.alphaTest>0&&(p.alphaTest.value=d.alphaTest);let _;d.map?_=d.map:d.alphaMap&&(_=d.alphaMap),_!==void 0&&(_.matrixAutoUpdate===!0&&_.updateMatrix(),p.uvTransform.value.copy(_.matrix))}function c(p,d){p.specular.value.copy(d.specular),p.shininess.value=Math.max(d.shininess,1e-4)}function u(p,d){d.gradientMap&&(p.gradientMap.value=d.gradientMap)}function f(p,d){p.roughness.value=d.roughness,p.metalness.value=d.metalness,d.roughnessMap&&(p.roughnessMap.value=d.roughnessMap),d.metalnessMap&&(p.metalnessMap.value=d.metalnessMap),e.get(d).envMap&&(p.envMapIntensity.value=d.envMapIntensity)}function h(p,d,_){p.ior.value=d.ior,d.sheen>0&&(p.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),p.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(p.sheenColorMap.value=d.sheenColorMap),d.sheenRoughnessMap&&(p.sheenRoughnessMap.value=d.sheenRoughnessMap)),d.clearcoat>0&&(p.clearcoat.value=d.clearcoat,p.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(p.clearcoatMap.value=d.clearcoatMap),d.clearcoatRoughnessMap&&(p.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap),d.clearcoatNormalMap&&(p.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),p.clearcoatNormalMap.value=d.clearcoatNormalMap,d.side===Vt&&p.clearcoatNormalScale.value.negate())),d.iridescence>0&&(p.iridescence.value=d.iridescence,p.iridescenceIOR.value=d.iridescenceIOR,p.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],p.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(p.iridescenceMap.value=d.iridescenceMap),d.iridescenceThicknessMap&&(p.iridescenceThicknessMap.value=d.iridescenceThicknessMap)),d.transmission>0&&(p.transmission.value=d.transmission,p.transmissionSamplerMap.value=_.texture,p.transmissionSamplerSize.value.set(_.width,_.height),d.transmissionMap&&(p.transmissionMap.value=d.transmissionMap),p.thickness.value=d.thickness,d.thicknessMap&&(p.thicknessMap.value=d.thicknessMap),p.attenuationDistance.value=d.attenuationDistance,p.attenuationColor.value.copy(d.attenuationColor)),p.specularIntensity.value=d.specularIntensity,p.specularColor.value.copy(d.specularColor),d.specularIntensityMap&&(p.specularIntensityMap.value=d.specularIntensityMap),d.specularColorMap&&(p.specularColorMap.value=d.specularColorMap)}function m(p,d){d.matcap&&(p.matcap.value=d.matcap)}function g(p,d){p.referencePosition.value.copy(d.referencePosition),p.nearDistance.value=d.nearDistance,p.farDistance.value=d.farDistance}return{refreshFogUniforms:t,refreshMaterialUniforms:i}}function dy(n,e,t,i){let r={},s={},a=[];const o=t.isWebGL2?n.getParameter(35375):0;function l(w,y){const T=y.program;i.uniformBlockBinding(w,T)}function c(w,y){let T=r[w.id];T===void 0&&(g(w),T=u(w),r[w.id]=T,w.addEventListener("dispose",d));const S=y.program;i.updateUBOMapping(w,S);const R=e.render.frame;s[w.id]!==R&&(h(w),s[w.id]=R)}function u(w){const y=f();w.__bindingPointIndex=y;const T=n.createBuffer(),S=w.__size,R=w.usage;return n.bindBuffer(35345,T),n.bufferData(35345,S,R),n.bindBuffer(35345,null),n.bindBufferBase(35345,y,T),T}function f(){for(let w=0;w<o;w++)if(a.indexOf(w)===-1)return a.push(w),w;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function h(w){const y=r[w.id],T=w.uniforms,S=w.__cache;n.bindBuffer(35345,y);for(let R=0,B=T.length;R<B;R++){const v=T[R];if(m(v,R,S)===!0){const L=v.__offset,O=Array.isArray(v.value)?v.value:[v.value];let $=0;for(let he=0;he<O.length;he++){const z=O[he],U=p(z);typeof z=="number"?(v.__data[0]=z,n.bufferSubData(35345,L+$,v.__data)):z.isMatrix3?(v.__data[0]=z.elements[0],v.__data[1]=z.elements[1],v.__data[2]=z.elements[2],v.__data[3]=z.elements[0],v.__data[4]=z.elements[3],v.__data[5]=z.elements[4],v.__data[6]=z.elements[5],v.__data[7]=z.elements[0],v.__data[8]=z.elements[6],v.__data[9]=z.elements[7],v.__data[10]=z.elements[8],v.__data[11]=z.elements[0]):(z.toArray(v.__data,$),$+=U.storage/Float32Array.BYTES_PER_ELEMENT)}n.bufferSubData(35345,L,v.__data)}}n.bindBuffer(35345,null)}function m(w,y,T){const S=w.value;if(T[y]===void 0){if(typeof S=="number")T[y]=S;else{const R=Array.isArray(S)?S:[S],B=[];for(let v=0;v<R.length;v++)B.push(R[v].clone());T[y]=B}return!0}else if(typeof S=="number"){if(T[y]!==S)return T[y]=S,!0}else{const R=Array.isArray(T[y])?T[y]:[T[y]],B=Array.isArray(S)?S:[S];for(let v=0;v<R.length;v++){const L=R[v];if(L.equals(B[v])===!1)return L.copy(B[v]),!0}}return!1}function g(w){const y=w.uniforms;let T=0;const S=16;let R=0;for(let B=0,v=y.length;B<v;B++){const L=y[B],O={boundary:0,storage:0},$=Array.isArray(L.value)?L.value:[L.value];for(let he=0,z=$.length;he<z;he++){const U=$[he],ee=p(U);O.boundary+=ee.boundary,O.storage+=ee.storage}if(L.__data=new Float32Array(O.storage/Float32Array.BYTES_PER_ELEMENT),L.__offset=T,B>0){R=T%S;const he=S-R;R!==0&&he-O.boundary<0&&(T+=S-R,L.__offset=T)}T+=O.storage}return R=T%S,R>0&&(T+=S-R),w.__size=T,w.__cache={},this}function p(w){const y={boundary:0,storage:0};return typeof w=="number"?(y.boundary=4,y.storage=4):w.isVector2?(y.boundary=8,y.storage=8):w.isVector3||w.isColor?(y.boundary=16,y.storage=12):w.isVector4?(y.boundary=16,y.storage=16):w.isMatrix3?(y.boundary=48,y.storage=48):w.isMatrix4?(y.boundary=64,y.storage=64):w.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",w),y}function d(w){const y=w.target;y.removeEventListener("dispose",d);const T=a.indexOf(y.__bindingPointIndex);a.splice(T,1),n.deleteBuffer(r[y.id]),delete r[y.id],delete s[y.id]}function _(){for(const w in r)n.deleteBuffer(r[w]);a=[],r={},s={}}return{bind:l,update:c,dispose:_}}function py(){const n=Ar("canvas");return n.style.display="block",n}function my(n={}){this.isWebGLRenderer=!0;const e=n.canvas!==void 0?n.canvas:py(),t=n.context!==void 0?n.context:null,i=n.depth!==void 0?n.depth:!0,r=n.stencil!==void 0?n.stencil:!0,s=n.antialias!==void 0?n.antialias:!1,a=n.premultipliedAlpha!==void 0?n.premultipliedAlpha:!0,o=n.preserveDrawingBuffer!==void 0?n.preserveDrawingBuffer:!1,l=n.powerPreference!==void 0?n.powerPreference:"default",c=n.failIfMajorPerformanceCaveat!==void 0?n.failIfMajorPerformanceCaveat:!1;let u;t!==null?u=t.getContextAttributes().alpha:u=n.alpha!==void 0?n.alpha:!1;let f=null,h=null;const m=[],g=[];this.domElement=e,this.debug={checkShaderErrors:!0},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.outputEncoding=ui,this.physicallyCorrectLights=!1,this.toneMapping=Mn,this.toneMappingExposure=1;const p=this;let d=!1,_=0,w=0,y=null,T=-1,S=null;const R=new ft,B=new ft;let v=null,L=e.width,O=e.height,$=1,he=null,z=null;const U=new ft(0,0,L,O),ee=new ft(0,0,L,O);let se=!1;const te=new Da;let W=!1,de=!1,ue=null;const q=new rt,Y=new Ue,fe=new V,_e={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};function I(){return y===null?$:1}let P=t;function ae(E,G){for(let J=0;J<E.length;J++){const k=E[J],ne=e.getContext(k,G);if(ne!==null)return ne}return null}try{const E={alpha:!0,depth:i,stencil:r,antialias:s,premultipliedAlpha:a,preserveDrawingBuffer:o,powerPreference:l,failIfMajorPerformanceCaveat:c};if("setAttribute"in e&&e.setAttribute("data-engine",`three.js r${Pa}`),e.addEventListener("webglcontextlost",Ce,!1),e.addEventListener("webglcontextrestored",we,!1),e.addEventListener("webglcontextcreationerror",Re,!1),P===null){const G=["webgl2","webgl","experimental-webgl"];if(p.isWebGL1Renderer===!0&&G.shift(),P=ae(G,E),P===null)throw ae(G)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}P.getShaderPrecisionFormat===void 0&&(P.getShaderPrecisionFormat=function(){return{rangeMin:1,rangeMax:1,precision:1}})}catch(E){throw console.error("THREE.WebGLRenderer: "+E.message),E}let ie,ve,xe,Ee,b,A,H,X,K,le,pe,re,me,oe,M,x,F,j,Q,ce,Me,C,N,be;function Te(){ie=new Ex(P),ve=new vx(P,ie,n),ie.init(ve),C=new ay(P,ie,ve),xe=new sy(P,ie,ve),Ee=new Cx,b=new qv,A=new oy(P,ie,xe,b,ve,C,Ee),H=new Mx(p),X=new wx(p),K=new Ug(P,ve),N=new _x(P,ie,K,ve),le=new Tx(P,K,Ee,N),pe=new Dx(P,le,K,Ee),Q=new Rx(P,ve,A),x=new yx(b),re=new Wv(p,H,X,ie,ve,N,x),me=new hy(p,b),oe=new jv,M=new Qv(ie,ve),j=new gx(p,H,X,xe,pe,u,a),F=new ry(p,pe,ve),be=new dy(P,Ee,ve,xe),ce=new xx(P,ie,Ee,ve),Me=new Ax(P,ie,Ee,ve),Ee.programs=re.programs,p.capabilities=ve,p.extensions=ie,p.properties=b,p.renderLists=oe,p.shadowMap=F,p.state=xe,p.info=Ee}Te();const Se=new fy(p,P);this.xr=Se,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){const E=ie.get("WEBGL_lose_context");E&&E.loseContext()},this.forceContextRestore=function(){const E=ie.get("WEBGL_lose_context");E&&E.restoreContext()},this.getPixelRatio=function(){return $},this.setPixelRatio=function(E){E!==void 0&&($=E,this.setSize(L,O,!1))},this.getSize=function(E){return E.set(L,O)},this.setSize=function(E,G,J){if(Se.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}L=E,O=G,e.width=Math.floor(E*$),e.height=Math.floor(G*$),J!==!1&&(e.style.width=E+"px",e.style.height=G+"px"),this.setViewport(0,0,E,G)},this.getDrawingBufferSize=function(E){return E.set(L*$,O*$).floor()},this.setDrawingBufferSize=function(E,G,J){L=E,O=G,$=J,e.width=Math.floor(E*J),e.height=Math.floor(G*J),this.setViewport(0,0,E,G)},this.getCurrentViewport=function(E){return E.copy(R)},this.getViewport=function(E){return E.copy(U)},this.setViewport=function(E,G,J,k){E.isVector4?U.set(E.x,E.y,E.z,E.w):U.set(E,G,J,k),xe.viewport(R.copy(U).multiplyScalar($).floor())},this.getScissor=function(E){return E.copy(ee)},this.setScissor=function(E,G,J,k){E.isVector4?ee.set(E.x,E.y,E.z,E.w):ee.set(E,G,J,k),xe.scissor(B.copy(ee).multiplyScalar($).floor())},this.getScissorTest=function(){return se},this.setScissorTest=function(E){xe.setScissorTest(se=E)},this.setOpaqueSort=function(E){he=E},this.setTransparentSort=function(E){z=E},this.getClearColor=function(E){return E.copy(j.getClearColor())},this.setClearColor=function(){j.setClearColor.apply(j,arguments)},this.getClearAlpha=function(){return j.getClearAlpha()},this.setClearAlpha=function(){j.setClearAlpha.apply(j,arguments)},this.clear=function(E=!0,G=!0,J=!0){let k=0;E&&(k|=16384),G&&(k|=256),J&&(k|=1024),P.clear(k)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){e.removeEventListener("webglcontextlost",Ce,!1),e.removeEventListener("webglcontextrestored",we,!1),e.removeEventListener("webglcontextcreationerror",Re,!1),oe.dispose(),M.dispose(),b.dispose(),H.dispose(),X.dispose(),pe.dispose(),N.dispose(),be.dispose(),re.dispose(),Se.dispose(),Se.removeEventListener("sessionstart",Ae),Se.removeEventListener("sessionend",Le),ue&&(ue.dispose(),ue=null),Xe.stop()};function Ce(E){E.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),d=!0}function we(){console.log("THREE.WebGLRenderer: Context Restored."),d=!1;const E=Ee.autoReset,G=F.enabled,J=F.autoUpdate,k=F.needsUpdate,ne=F.type;Te(),Ee.autoReset=E,F.enabled=G,F.autoUpdate=J,F.needsUpdate=k,F.type=ne}function Re(E){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",E.statusMessage)}function ze(E){const G=E.target;G.removeEventListener("dispose",ze),Ye(G)}function Ye(E){D(E),b.remove(E)}function D(E){const G=b.get(E).programs;G!==void 0&&(G.forEach(function(J){re.releaseProgram(J)}),E.isShaderMaterial&&re.releaseShaderCache(E))}this.renderBufferDirect=function(E,G,J,k,ne,Pe){G===null&&(G=_e);const De=ne.isMesh&&ne.matrixWorld.determinant()<0,Ne=If(E,G,J,k,ne);xe.setMaterial(k,De);let Be=J.index,We=1;k.wireframe===!0&&(Be=le.getWireframeAttribute(J),We=2);const ke=J.drawRange,Ge=J.attributes.position;let tt=ke.start*We,Ct=(ke.start+ke.count)*We;Pe!==null&&(tt=Math.max(tt,Pe.start*We),Ct=Math.min(Ct,(Pe.start+Pe.count)*We)),Be!==null?(tt=Math.max(tt,0),Ct=Math.min(Ct,Be.count)):Ge!=null&&(tt=Math.max(tt,0),Ct=Math.min(Ct,Ge.count));const un=Ct-tt;if(un<0||un===1/0)return;N.setup(ne,k,Ne,J,Be);let kn,nt=ce;if(Be!==null&&(kn=K.get(Be),nt=Me,nt.setIndex(kn)),ne.isMesh)k.wireframe===!0?(xe.setLineWidth(k.wireframeLinewidth*I()),nt.setMode(1)):nt.setMode(4);else if(ne.isLine){let He=k.linewidth;He===void 0&&(He=1),xe.setLineWidth(He*I()),ne.isLineSegments?nt.setMode(1):ne.isLineLoop?nt.setMode(2):nt.setMode(3)}else ne.isPoints?nt.setMode(0):ne.isSprite&&nt.setMode(4);if(ne.isInstancedMesh)nt.renderInstances(tt,un,ne.count);else if(J.isInstancedBufferGeometry){const He=J._maxInstanceCount!==void 0?J._maxInstanceCount:1/0,Ns=Math.min(J.instanceCount,He);nt.renderInstances(tt,un,Ns)}else nt.render(tt,un)},this.compile=function(E,G){function J(k,ne,Pe){k.transparent===!0&&k.side===kr?(k.side=Vt,k.needsUpdate=!0,Ot(k,ne,Pe),k.side=li,k.needsUpdate=!0,Ot(k,ne,Pe),k.side=kr):Ot(k,ne,Pe)}h=M.get(E),h.init(),g.push(h),E.traverseVisible(function(k){k.isLight&&k.layers.test(G.layers)&&(h.pushLight(k),k.castShadow&&h.pushShadow(k))}),h.setupLights(p.physicallyCorrectLights),E.traverse(function(k){const ne=k.material;if(ne)if(Array.isArray(ne))for(let Pe=0;Pe<ne.length;Pe++){const De=ne[Pe];J(De,E,k)}else J(ne,E,k)}),g.pop(),h=null};let Z=null;function ge(E){Z&&Z(E)}function Ae(){Xe.stop()}function Le(){Xe.start()}const Xe=new bf;Xe.setAnimationLoop(ge),typeof self<"u"&&Xe.setContext(self),this.setAnimationLoop=function(E){Z=E,Se.setAnimationLoop(E),E===null?Xe.stop():Xe.start()},Se.addEventListener("sessionstart",Ae),Se.addEventListener("sessionend",Le),this.render=function(E,G){if(G!==void 0&&G.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(d===!0)return;E.matrixWorldAutoUpdate===!0&&E.updateMatrixWorld(),G.parent===null&&G.matrixWorldAutoUpdate===!0&&G.updateMatrixWorld(),Se.enabled===!0&&Se.isPresenting===!0&&(Se.cameraAutoUpdate===!0&&Se.updateCamera(G),G=Se.getCamera()),E.isScene===!0&&E.onBeforeRender(p,E,G,y),h=M.get(E,g.length),h.init(),g.push(h),q.multiplyMatrices(G.projectionMatrix,G.matrixWorldInverse),te.setFromProjectionMatrix(q),de=this.localClippingEnabled,W=x.init(this.clippingPlanes,de,G),f=oe.get(E,m.length),f.init(),m.push(f),lt(E,G,0,p.sortObjects),f.finish(),p.sortObjects===!0&&f.sort(he,z),W===!0&&x.beginShadows();const J=h.state.shadowsArray;if(F.render(J,E,G),W===!0&&x.endShadows(),this.info.autoReset===!0&&this.info.reset(),j.render(f,E),h.setupLights(p.physicallyCorrectLights),G.isArrayCamera){const k=G.cameras;for(let ne=0,Pe=k.length;ne<Pe;ne++){const De=k[ne];pt(f,E,De,De.viewport)}}else pt(f,E,G);y!==null&&(A.updateMultisampleRenderTarget(y),A.updateRenderTargetMipmap(y)),E.isScene===!0&&E.onAfterRender(p,E,G),N.resetDefaultState(),T=-1,S=null,g.pop(),g.length>0?h=g[g.length-1]:h=null,m.pop(),m.length>0?f=m[m.length-1]:f=null};function lt(E,G,J,k){if(E.visible===!1)return;if(E.layers.test(G.layers)){if(E.isGroup)J=E.renderOrder;else if(E.isLOD)E.autoUpdate===!0&&E.update(G);else if(E.isLight)h.pushLight(E),E.castShadow&&h.pushShadow(E);else if(E.isSprite){if(!E.frustumCulled||te.intersectsSprite(E)){k&&fe.setFromMatrixPosition(E.matrixWorld).applyMatrix4(q);const De=pe.update(E),Ne=E.material;Ne.visible&&f.push(E,De,Ne,J,fe.z,null)}}else if((E.isMesh||E.isLine||E.isPoints)&&(E.isSkinnedMesh&&E.skeleton.frame!==Ee.render.frame&&(E.skeleton.update(),E.skeleton.frame=Ee.render.frame),!E.frustumCulled||te.intersectsObject(E))){k&&fe.setFromMatrixPosition(E.matrixWorld).applyMatrix4(q);const De=pe.update(E),Ne=E.material;if(Array.isArray(Ne)){const Be=De.groups;for(let We=0,ke=Be.length;We<ke;We++){const Ge=Be[We],tt=Ne[Ge.materialIndex];tt&&tt.visible&&f.push(E,De,tt,J,fe.z,Ge)}}else Ne.visible&&f.push(E,De,Ne,J,fe.z,null)}}const Pe=E.children;for(let De=0,Ne=Pe.length;De<Ne;De++)lt(Pe[De],G,J,k)}function pt(E,G,J,k){const ne=E.opaque,Pe=E.transmissive,De=E.transparent;h.setupLightsView(J),Pe.length>0&&Bn(ne,G,J),k&&xe.viewport(R.copy(k)),ne.length>0&&Ze(ne,G,J),Pe.length>0&&Ze(Pe,G,J),De.length>0&&Ze(De,G,J),xe.buffers.depth.setTest(!0),xe.buffers.depth.setMask(!0),xe.buffers.color.setMask(!0),xe.setPolygonOffset(!1)}function Bn(E,G,J){const k=ve.isWebGL2;ue===null&&(ue=new fi(1,1,{generateMipmaps:!0,type:ie.has("EXT_color_buffer_half_float")?Er:ci,minFilter:wr,samples:k&&s===!0?4:0})),p.getDrawingBufferSize(Y),k?ue.setSize(Y.x,Y.y):ue.setSize(na(Y.x),na(Y.y));const ne=p.getRenderTarget();p.setRenderTarget(ue),p.clear();const Pe=p.toneMapping;p.toneMapping=Mn,Ze(E,G,J),p.toneMapping=Pe,A.updateMultisampleRenderTarget(ue),A.updateRenderTargetMipmap(ue),p.setRenderTarget(ne)}function Ze(E,G,J){const k=G.isScene===!0?G.overrideMaterial:null;for(let ne=0,Pe=E.length;ne<Pe;ne++){const De=E[ne],Ne=De.object,Be=De.geometry,We=k===null?De.material:k,ke=De.group;Ne.layers.test(J.layers)&&cn(Ne,G,J,Be,We,ke)}}function cn(E,G,J,k,ne,Pe){E.onBeforeRender(p,G,J,k,ne,Pe),E.modelViewMatrix.multiplyMatrices(J.matrixWorldInverse,E.matrixWorld),E.normalMatrix.getNormalMatrix(E.modelViewMatrix),ne.onBeforeRender(p,G,J,k,E,Pe),ne.transparent===!0&&ne.side===kr?(ne.side=Vt,ne.needsUpdate=!0,p.renderBufferDirect(J,G,k,ne,E,Pe),ne.side=li,ne.needsUpdate=!0,p.renderBufferDirect(J,G,k,ne,E,Pe),ne.side=kr):p.renderBufferDirect(J,G,k,ne,E,Pe),E.onAfterRender(p,G,J,k,ne,Pe)}function Ot(E,G,J){G.isScene!==!0&&(G=_e);const k=b.get(E),ne=h.state.lights,Pe=h.state.shadowsArray,De=ne.state.version,Ne=re.getParameters(E,ne.state,Pe,G,J),Be=re.getProgramCacheKey(Ne);let We=k.programs;k.environment=E.isMeshStandardMaterial?G.environment:null,k.fog=G.fog,k.envMap=(E.isMeshStandardMaterial?X:H).get(E.envMap||k.environment),We===void 0&&(E.addEventListener("dispose",ze),We=new Map,k.programs=We);let ke=We.get(Be);if(ke!==void 0){if(k.currentProgram===ke&&k.lightsStateVersion===De)return Oa(E,Ne),ke}else Ne.uniforms=re.getUniforms(E),E.onBuild(J,Ne,p),E.onBeforeCompile(Ne,p),ke=re.acquireProgram(Ne,Be),We.set(Be,ke),k.uniforms=Ne.uniforms;const Ge=k.uniforms;(!E.isShaderMaterial&&!E.isRawShaderMaterial||E.clipping===!0)&&(Ge.clippingPlanes=x.uniform),Oa(E,Ne),k.needsLights=Of(E),k.lightsStateVersion=De,k.needsLights&&(Ge.ambientLightColor.value=ne.state.ambient,Ge.lightProbe.value=ne.state.probe,Ge.directionalLights.value=ne.state.directional,Ge.directionalLightShadows.value=ne.state.directionalShadow,Ge.spotLights.value=ne.state.spot,Ge.spotLightShadows.value=ne.state.spotShadow,Ge.rectAreaLights.value=ne.state.rectArea,Ge.ltc_1.value=ne.state.rectAreaLTC1,Ge.ltc_2.value=ne.state.rectAreaLTC2,Ge.pointLights.value=ne.state.point,Ge.pointLightShadows.value=ne.state.pointShadow,Ge.hemisphereLights.value=ne.state.hemi,Ge.directionalShadowMap.value=ne.state.directionalShadowMap,Ge.directionalShadowMatrix.value=ne.state.directionalShadowMatrix,Ge.spotShadowMap.value=ne.state.spotShadowMap,Ge.spotLightMatrix.value=ne.state.spotLightMatrix,Ge.spotLightMap.value=ne.state.spotLightMap,Ge.pointShadowMap.value=ne.state.pointShadowMap,Ge.pointShadowMatrix.value=ne.state.pointShadowMatrix);const tt=ke.getUniforms(),Ct=ms.seqWithValue(tt.seq,Ge);return k.currentProgram=ke,k.uniformsList=Ct,ke}function Oa(E,G){const J=b.get(E);J.outputEncoding=G.outputEncoding,J.instancing=G.instancing,J.skinning=G.skinning,J.morphTargets=G.morphTargets,J.morphNormals=G.morphNormals,J.morphColors=G.morphColors,J.morphTargetsCount=G.morphTargetsCount,J.numClippingPlanes=G.numClippingPlanes,J.numIntersection=G.numClipIntersection,J.vertexAlphas=G.vertexAlphas,J.vertexTangents=G.vertexTangents,J.toneMapping=G.toneMapping}function If(E,G,J,k,ne){G.isScene!==!0&&(G=_e),A.resetTextureUnits();const Pe=G.fog,De=k.isMeshStandardMaterial?G.environment:null,Ne=y===null?p.outputEncoding:y.isXRRenderTarget===!0?y.texture.encoding:ui,Be=(k.isMeshStandardMaterial?X:H).get(k.envMap||De),We=k.vertexColors===!0&&!!J.attributes.color&&J.attributes.color.itemSize===4,ke=!!k.normalMap&&!!J.attributes.tangent,Ge=!!J.morphAttributes.position,tt=!!J.morphAttributes.normal,Ct=!!J.morphAttributes.color,un=k.toneMapped?p.toneMapping:Mn,kn=J.morphAttributes.position||J.morphAttributes.normal||J.morphAttributes.color,nt=kn!==void 0?kn.length:0,He=b.get(k),Ns=h.state.lights;if(W===!0&&(de===!0||E!==S)){const Lt=E===S&&k.id===T;x.setState(k,E,Lt)}let ct=!1;k.version===He.__version?(He.needsLights&&He.lightsStateVersion!==Ns.state.version||He.outputEncoding!==Ne||ne.isInstancedMesh&&He.instancing===!1||!ne.isInstancedMesh&&He.instancing===!0||ne.isSkinnedMesh&&He.skinning===!1||!ne.isSkinnedMesh&&He.skinning===!0||He.envMap!==Be||k.fog===!0&&He.fog!==Pe||He.numClippingPlanes!==void 0&&(He.numClippingPlanes!==x.numPlanes||He.numIntersection!==x.numIntersection)||He.vertexAlphas!==We||He.vertexTangents!==ke||He.morphTargets!==Ge||He.morphNormals!==tt||He.morphColors!==Ct||He.toneMapping!==un||ve.isWebGL2===!0&&He.morphTargetsCount!==nt)&&(ct=!0):(ct=!0,He.__version=k.version);let Gn=He.currentProgram;ct===!0&&(Gn=Ot(k,G,ne));let Na=!1,er=!1,Us=!1;const vt=Gn.getUniforms(),Hn=He.uniforms;if(xe.useProgram(Gn.program)&&(Na=!0,er=!0,Us=!0),k.id!==T&&(T=k.id,er=!0),Na||S!==E){if(vt.setValue(P,"projectionMatrix",E.projectionMatrix),ve.logarithmicDepthBuffer&&vt.setValue(P,"logDepthBufFC",2/(Math.log(E.far+1)/Math.LN2)),S!==E&&(S=E,er=!0,Us=!0),k.isShaderMaterial||k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshStandardMaterial||k.envMap){const Lt=vt.map.cameraPosition;Lt!==void 0&&Lt.setValue(P,fe.setFromMatrixPosition(E.matrixWorld))}(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial)&&vt.setValue(P,"isOrthographic",E.isOrthographicCamera===!0),(k.isMeshPhongMaterial||k.isMeshToonMaterial||k.isMeshLambertMaterial||k.isMeshBasicMaterial||k.isMeshStandardMaterial||k.isShaderMaterial||k.isShadowMaterial||ne.isSkinnedMesh)&&vt.setValue(P,"viewMatrix",E.matrixWorldInverse)}if(ne.isSkinnedMesh){vt.setOptional(P,ne,"bindMatrix"),vt.setOptional(P,ne,"bindMatrixInverse");const Lt=ne.skeleton;Lt&&(ve.floatVertexTextures?(Lt.boneTexture===null&&Lt.computeBoneTexture(),vt.setValue(P,"boneTexture",Lt.boneTexture,A),vt.setValue(P,"boneTextureSize",Lt.boneTextureSize)):console.warn("THREE.WebGLRenderer: SkinnedMesh can only be used with WebGL 2. With WebGL 1 OES_texture_float and vertex textures support is required."))}const zs=J.morphAttributes;if((zs.position!==void 0||zs.normal!==void 0||zs.color!==void 0&&ve.isWebGL2===!0)&&Q.update(ne,J,k,Gn),(er||He.receiveShadow!==ne.receiveShadow)&&(He.receiveShadow=ne.receiveShadow,vt.setValue(P,"receiveShadow",ne.receiveShadow)),k.isMeshGouraudMaterial&&k.envMap!==null&&(Hn.envMap.value=Be,Hn.flipEnvMap.value=Be.isCubeTexture&&Be.isRenderTargetTexture===!1?-1:1),er&&(vt.setValue(P,"toneMappingExposure",p.toneMappingExposure),He.needsLights&&Ff(Hn,Us),Pe&&k.fog===!0&&me.refreshFogUniforms(Hn,Pe),me.refreshMaterialUniforms(Hn,k,$,O,ue),ms.upload(P,He.uniformsList,Hn,A)),k.isShaderMaterial&&k.uniformsNeedUpdate===!0&&(ms.upload(P,He.uniformsList,Hn,A),k.uniformsNeedUpdate=!1),k.isSpriteMaterial&&vt.setValue(P,"center",ne.center),vt.setValue(P,"modelViewMatrix",ne.modelViewMatrix),vt.setValue(P,"normalMatrix",ne.normalMatrix),vt.setValue(P,"modelMatrix",ne.matrixWorld),k.isShaderMaterial||k.isRawShaderMaterial){const Lt=k.uniformsGroups;for(let Bs=0,Nf=Lt.length;Bs<Nf;Bs++)if(ve.isWebGL2){const Ua=Lt[Bs];be.update(Ua,Gn),be.bind(Ua,Gn)}else console.warn("THREE.WebGLRenderer: Uniform Buffer Objects can only be used with WebGL 2.")}return Gn}function Ff(E,G){E.ambientLightColor.needsUpdate=G,E.lightProbe.needsUpdate=G,E.directionalLights.needsUpdate=G,E.directionalLightShadows.needsUpdate=G,E.pointLights.needsUpdate=G,E.pointLightShadows.needsUpdate=G,E.spotLights.needsUpdate=G,E.spotLightShadows.needsUpdate=G,E.rectAreaLights.needsUpdate=G,E.hemisphereLights.needsUpdate=G}function Of(E){return E.isMeshLambertMaterial||E.isMeshToonMaterial||E.isMeshPhongMaterial||E.isMeshStandardMaterial||E.isShadowMaterial||E.isShaderMaterial&&E.lights===!0}this.getActiveCubeFace=function(){return _},this.getActiveMipmapLevel=function(){return w},this.getRenderTarget=function(){return y},this.setRenderTargetTextures=function(E,G,J){b.get(E.texture).__webglTexture=G,b.get(E.depthTexture).__webglTexture=J;const k=b.get(E);k.__hasExternalTextures=!0,k.__hasExternalTextures&&(k.__autoAllocateDepthBuffer=J===void 0,k.__autoAllocateDepthBuffer||ie.has("WEBGL_multisampled_render_to_texture")===!0&&(console.warn("THREE.WebGLRenderer: Render-to-texture extension was disabled because an external texture was provided"),k.__useRenderToTexture=!1))},this.setRenderTargetFramebuffer=function(E,G){const J=b.get(E);J.__webglFramebuffer=G,J.__useDefaultFramebuffer=G===void 0},this.setRenderTarget=function(E,G=0,J=0){y=E,_=G,w=J;let k=!0,ne=null,Pe=!1,De=!1;if(E){const Be=b.get(E);Be.__useDefaultFramebuffer!==void 0?(xe.bindFramebuffer(36160,null),k=!1):Be.__webglFramebuffer===void 0?A.setupRenderTarget(E):Be.__hasExternalTextures&&A.rebindTextures(E,b.get(E.texture).__webglTexture,b.get(E.depthTexture).__webglTexture);const We=E.texture;(We.isData3DTexture||We.isDataArrayTexture||We.isCompressedArrayTexture)&&(De=!0);const ke=b.get(E).__webglFramebuffer;E.isWebGLCubeRenderTarget?(ne=ke[G],Pe=!0):ve.isWebGL2&&E.samples>0&&A.useMultisampledRTT(E)===!1?ne=b.get(E).__webglMultisampledFramebuffer:ne=ke,R.copy(E.viewport),B.copy(E.scissor),v=E.scissorTest}else R.copy(U).multiplyScalar($).floor(),B.copy(ee).multiplyScalar($).floor(),v=se;if(xe.bindFramebuffer(36160,ne)&&ve.drawBuffers&&k&&xe.drawBuffers(E,ne),xe.viewport(R),xe.scissor(B),xe.setScissorTest(v),Pe){const Be=b.get(E.texture);P.framebufferTexture2D(36160,36064,34069+G,Be.__webglTexture,J)}else if(De){const Be=b.get(E.texture),We=G||0;P.framebufferTextureLayer(36160,36064,Be.__webglTexture,J||0,We)}T=-1},this.readRenderTargetPixels=function(E,G,J,k,ne,Pe,De){if(!(E&&E.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let Ne=b.get(E).__webglFramebuffer;if(E.isWebGLCubeRenderTarget&&De!==void 0&&(Ne=Ne[De]),Ne){xe.bindFramebuffer(36160,Ne);try{const Be=E.texture,We=Be.format,ke=Be.type;if(We!==Kt&&C.convert(We)!==P.getParameter(35739)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}const Ge=ke===Er&&(ie.has("EXT_color_buffer_half_float")||ve.isWebGL2&&ie.has("EXT_color_buffer_float"));if(ke!==ci&&C.convert(ke)!==P.getParameter(35738)&&!(ke===ni&&(ve.isWebGL2||ie.has("OES_texture_float")||ie.has("WEBGL_color_buffer_float")))&&!Ge){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}G>=0&&G<=E.width-k&&J>=0&&J<=E.height-ne&&P.readPixels(G,J,k,ne,C.convert(We),C.convert(ke),Pe)}finally{const Be=y!==null?b.get(y).__webglFramebuffer:null;xe.bindFramebuffer(36160,Be)}}},this.copyFramebufferToTexture=function(E,G,J=0){const k=Math.pow(2,-J),ne=Math.floor(G.image.width*k),Pe=Math.floor(G.image.height*k);A.setTexture2D(G,0),P.copyTexSubImage2D(3553,J,0,0,E.x,E.y,ne,Pe),xe.unbindTexture()},this.copyTextureToTexture=function(E,G,J,k=0){const ne=G.image.width,Pe=G.image.height,De=C.convert(J.format),Ne=C.convert(J.type);A.setTexture2D(J,0),P.pixelStorei(37440,J.flipY),P.pixelStorei(37441,J.premultiplyAlpha),P.pixelStorei(3317,J.unpackAlignment),G.isDataTexture?P.texSubImage2D(3553,k,E.x,E.y,ne,Pe,De,Ne,G.image.data):G.isCompressedTexture?P.compressedTexSubImage2D(3553,k,E.x,E.y,G.mipmaps[0].width,G.mipmaps[0].height,De,G.mipmaps[0].data):P.texSubImage2D(3553,k,E.x,E.y,De,Ne,G.image),k===0&&J.generateMipmaps&&P.generateMipmap(3553),xe.unbindTexture()},this.copyTextureToTexture3D=function(E,G,J,k,ne=0){if(p.isWebGL1Renderer){console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: can only be used with WebGL2.");return}const Pe=E.max.x-E.min.x+1,De=E.max.y-E.min.y+1,Ne=E.max.z-E.min.z+1,Be=C.convert(k.format),We=C.convert(k.type);let ke;if(k.isData3DTexture)A.setTexture3D(k,0),ke=32879;else if(k.isDataArrayTexture)A.setTexture2DArray(k,0),ke=35866;else{console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: only supports THREE.DataTexture3D and THREE.DataTexture2DArray.");return}P.pixelStorei(37440,k.flipY),P.pixelStorei(37441,k.premultiplyAlpha),P.pixelStorei(3317,k.unpackAlignment);const Ge=P.getParameter(3314),tt=P.getParameter(32878),Ct=P.getParameter(3316),un=P.getParameter(3315),kn=P.getParameter(32877),nt=J.isCompressedTexture?J.mipmaps[0]:J.image;P.pixelStorei(3314,nt.width),P.pixelStorei(32878,nt.height),P.pixelStorei(3316,E.min.x),P.pixelStorei(3315,E.min.y),P.pixelStorei(32877,E.min.z),J.isDataTexture||J.isData3DTexture?P.texSubImage3D(ke,ne,G.x,G.y,G.z,Pe,De,Ne,Be,We,nt.data):J.isCompressedArrayTexture?(console.warn("THREE.WebGLRenderer.copyTextureToTexture3D: untested support for compressed srcTexture."),P.compressedTexSubImage3D(ke,ne,G.x,G.y,G.z,Pe,De,Ne,Be,nt.data)):P.texSubImage3D(ke,ne,G.x,G.y,G.z,Pe,De,Ne,Be,We,nt),P.pixelStorei(3314,Ge),P.pixelStorei(32878,tt),P.pixelStorei(3316,Ct),P.pixelStorei(3315,un),P.pixelStorei(32877,kn),ne===0&&k.generateMipmaps&&P.generateMipmap(ke),xe.unbindTexture()},this.initTexture=function(E){E.isCubeTexture?A.setTextureCube(E,0):E.isData3DTexture?A.setTexture3D(E,0):E.isDataArrayTexture||E.isCompressedArrayTexture?A.setTexture2DArray(E,0):A.setTexture2D(E,0),xe.unbindTexture()},this.resetState=function(){_=0,w=0,y=null,xe.reset(),N.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}class Cf extends my{}Cf.prototype.isWebGL1Renderer=!0;class gy extends ht{constructor(){super(),this.isScene=!0,this.type="Scene",this.background=null,this.environment=null,this.fog=null,this.backgroundBlurriness=0,this.backgroundIntensity=1,this.overrideMaterial=null,typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}copy(e,t){return super.copy(e,t),e.background!==null&&(this.background=e.background.clone()),e.environment!==null&&(this.environment=e.environment.clone()),e.fog!==null&&(this.fog=e.fog.clone()),this.backgroundBlurriness=e.backgroundBlurriness,this.backgroundIntensity=e.backgroundIntensity,e.overrideMaterial!==null&&(this.overrideMaterial=e.overrideMaterial.clone()),this.matrixAutoUpdate=e.matrixAutoUpdate,this}toJSON(e){const t=super.toJSON(e);return this.fog!==null&&(t.object.fog=this.fog.toJSON()),this.backgroundBlurriness>0&&(t.backgroundBlurriness=this.backgroundBlurriness),this.backgroundIntensity!==1&&(t.backgroundIntensity=this.backgroundIntensity),t}get autoUpdate(){return console.warn("THREE.Scene: autoUpdate was renamed to matrixWorldAutoUpdate in r144."),this.matrixWorldAutoUpdate}set autoUpdate(e){console.warn("THREE.Scene: autoUpdate was renamed to matrixWorldAutoUpdate in r144."),this.matrixWorldAutoUpdate=e}}class Lf extends Dr{constructor(e){super(),this.isPointsMaterial=!0,this.type="PointsMaterial",this.color=new Ke(16777215),this.map=null,this.alphaMap=null,this.size=1,this.sizeAttenuation=!0,this.fog=!0,this.setValues(e)}copy(e){return super.copy(e),this.color.copy(e.color),this.map=e.map,this.alphaMap=e.alphaMap,this.size=e.size,this.sizeAttenuation=e.sizeAttenuation,this.fog=e.fog,this}}const zc=new rt,ra=new pf,as=new Fs,ls=new V;class _y extends ht{constructor(e=new wn,t=new Lf){super(),this.isPoints=!0,this.type="Points",this.geometry=e,this.material=t,this.updateMorphTargets()}copy(e,t){return super.copy(e,t),this.material=e.material,this.geometry=e.geometry,this}raycast(e,t){const i=this.geometry,r=this.matrixWorld,s=e.params.Points.threshold,a=i.drawRange;if(i.boundingSphere===null&&i.computeBoundingSphere(),as.copy(i.boundingSphere),as.applyMatrix4(r),as.radius+=s,e.ray.intersectsSphere(as)===!1)return;zc.copy(r).invert(),ra.copy(e.ray).applyMatrix4(zc);const o=s/((this.scale.x+this.scale.y+this.scale.z)/3),l=o*o,c=i.index,f=i.attributes.position;if(c!==null){const h=Math.max(0,a.start),m=Math.min(c.count,a.start+a.count);for(let g=h,p=m;g<p;g++){const d=c.getX(g);ls.fromBufferAttribute(f,d),Bc(ls,d,l,r,e,t,this)}}else{const h=Math.max(0,a.start),m=Math.min(f.count,a.start+a.count);for(let g=h,p=m;g<p;g++)ls.fromBufferAttribute(f,g),Bc(ls,g,l,r,e,t,this)}}updateMorphTargets(){const t=this.geometry.morphAttributes,i=Object.keys(t);if(i.length>0){const r=t[i[0]];if(r!==void 0){this.morphTargetInfluences=[],this.morphTargetDictionary={};for(let s=0,a=r.length;s<a;s++){const o=r[s].name||String(s);this.morphTargetInfluences.push(0),this.morphTargetDictionary[o]=s}}}}}function Bc(n,e,t,i,r,s,a){const o=ra.distanceSqToPoint(n);if(o<t){const l=new V;ra.closestPointToPoint(n,l),l.applyMatrix4(i);const c=r.ray.origin.distanceTo(l);if(c<r.near||c>r.far)return;s.push({distance:c,distanceToRay:Math.sqrt(o),point:l,index:e,face:null,object:a})}}const kc={enabled:!1,files:{},add:function(n,e){this.enabled!==!1&&(this.files[n]=e)},get:function(n){if(this.enabled!==!1)return this.files[n]},remove:function(n){delete this.files[n]},clear:function(){this.files={}}};class xy{constructor(e,t,i){const r=this;let s=!1,a=0,o=0,l;const c=[];this.onStart=void 0,this.onLoad=e,this.onProgress=t,this.onError=i,this.itemStart=function(u){o++,s===!1&&r.onStart!==void 0&&r.onStart(u,a,o),s=!0},this.itemEnd=function(u){a++,r.onProgress!==void 0&&r.onProgress(u,a,o),a===o&&(s=!1,r.onLoad!==void 0&&r.onLoad())},this.itemError=function(u){r.onError!==void 0&&r.onError(u)},this.resolveURL=function(u){return l?l(u):u},this.setURLModifier=function(u){return l=u,this},this.addHandler=function(u,f){return c.push(u,f),this},this.removeHandler=function(u){const f=c.indexOf(u);return f!==-1&&c.splice(f,2),this},this.getHandler=function(u){for(let f=0,h=c.length;f<h;f+=2){const m=c[f],g=c[f+1];if(m.global&&(m.lastIndex=0),m.test(u))return g}return null}}}const vy=new xy;class Pf{constructor(e){this.manager=e!==void 0?e:vy,this.crossOrigin="anonymous",this.withCredentials=!1,this.path="",this.resourcePath="",this.requestHeader={}}load(){}loadAsync(e,t){const i=this;return new Promise(function(r,s){i.load(e,r,t,s)})}parse(){}setCrossOrigin(e){return this.crossOrigin=e,this}setWithCredentials(e){return this.withCredentials=e,this}setPath(e){return this.path=e,this}setResourcePath(e){return this.resourcePath=e,this}setRequestHeader(e){return this.requestHeader=e,this}}class yy extends Pf{constructor(e){super(e)}load(e,t,i,r){this.path!==void 0&&(e=this.path+e),e=this.manager.resolveURL(e);const s=this,a=kc.get(e);if(a!==void 0)return s.manager.itemStart(e),setTimeout(function(){t&&t(a),s.manager.itemEnd(e)},0),a;const o=Ar("img");function l(){u(),kc.add(e,this),t&&t(this),s.manager.itemEnd(e)}function c(f){u(),r&&r(f),s.manager.itemError(e),s.manager.itemEnd(e)}function u(){o.removeEventListener("load",l,!1),o.removeEventListener("error",c,!1)}return o.addEventListener("load",l,!1),o.addEventListener("error",c,!1),e.slice(0,5)!=="data:"&&this.crossOrigin!==void 0&&(o.crossOrigin=this.crossOrigin),s.manager.itemStart(e),o.src=e,o}}class My extends Pf{constructor(e){super(e)}load(e,t,i,r){const s=new Tt,a=new yy(this.manager);return a.setCrossOrigin(this.crossOrigin),a.setPath(this.path),a.load(e,function(o){s.image=o,s.needsUpdate=!0,t!==void 0&&t(s)},i,r),s}}class Rf extends ht{constructor(e,t=1){super(),this.isLight=!0,this.type="Light",this.color=new Ke(e),this.intensity=t}dispose(){}copy(e,t){return super.copy(e,t),this.color.copy(e.color),this.intensity=e.intensity,this}toJSON(e){const t=super.toJSON(e);return t.object.color=this.color.getHex(),t.object.intensity=this.intensity,this.groundColor!==void 0&&(t.object.groundColor=this.groundColor.getHex()),this.distance!==void 0&&(t.object.distance=this.distance),this.angle!==void 0&&(t.object.angle=this.angle),this.decay!==void 0&&(t.object.decay=this.decay),this.penumbra!==void 0&&(t.object.penumbra=this.penumbra),this.shadow!==void 0&&(t.object.shadow=this.shadow.toJSON()),t}}const Po=new rt,Gc=new V,Hc=new V;class by{constructor(e){this.camera=e,this.bias=0,this.normalBias=0,this.radius=1,this.blurSamples=8,this.mapSize=new Ue(512,512),this.map=null,this.mapPass=null,this.matrix=new rt,this.autoUpdate=!0,this.needsUpdate=!1,this._frustum=new Da,this._frameExtents=new Ue(1,1),this._viewportCount=1,this._viewports=[new ft(0,0,1,1)]}getViewportCount(){return this._viewportCount}getFrustum(){return this._frustum}updateMatrices(e){const t=this.camera,i=this.matrix;Gc.setFromMatrixPosition(e.matrixWorld),t.position.copy(Gc),Hc.setFromMatrixPosition(e.target.matrixWorld),t.lookAt(Hc),t.updateMatrixWorld(),Po.multiplyMatrices(t.projectionMatrix,t.matrixWorldInverse),this._frustum.setFromProjectionMatrix(Po),i.set(.5,0,0,.5,0,.5,0,.5,0,0,.5,.5,0,0,0,1),i.multiply(Po)}getViewport(e){return this._viewports[e]}getFrameExtents(){return this._frameExtents}dispose(){this.map&&this.map.dispose(),this.mapPass&&this.mapPass.dispose()}copy(e){return this.camera=e.camera.clone(),this.bias=e.bias,this.radius=e.radius,this.mapSize.copy(e.mapSize),this}clone(){return new this.constructor().copy(this)}toJSON(){const e={};return this.bias!==0&&(e.bias=this.bias),this.normalBias!==0&&(e.normalBias=this.normalBias),this.radius!==1&&(e.radius=this.radius),(this.mapSize.x!==512||this.mapSize.y!==512)&&(e.mapSize=this.mapSize.toArray()),e.camera=this.camera.toJSON(!1).object,delete e.camera.matrix,e}}class Sy extends by{constructor(){super(new Sf(-5,5,5,-5,.5,500)),this.isDirectionalLightShadow=!0}}class wy extends Rf{constructor(e,t){super(e,t),this.isDirectionalLight=!0,this.type="DirectionalLight",this.position.copy(ht.DefaultUp),this.updateMatrix(),this.target=new ht,this.shadow=new Sy}dispose(){this.shadow.dispose()}copy(e){return super.copy(e),this.target=e.target.clone(),this.shadow=e.shadow.clone(),this}}class Ey extends Rf{constructor(e,t){super(e,t),this.isAmbientLight=!0,this.type="AmbientLight"}}class Vc{constructor(e=1,t=0,i=0){return this.radius=e,this.phi=t,this.theta=i,this}set(e,t,i){return this.radius=e,this.phi=t,this.theta=i,this}copy(e){return this.radius=e.radius,this.phi=e.phi,this.theta=e.theta,this}makeSafe(){return this.phi=Math.max(1e-6,Math.min(Math.PI-1e-6,this.phi)),this}setFromVector3(e){return this.setFromCartesianCoords(e.x,e.y,e.z)}setFromCartesianCoords(e,t,i){return this.radius=Math.sqrt(e*e+t*t+i*i),this.radius===0?(this.theta=0,this.phi=0):(this.theta=Math.atan2(e,i),this.phi=Math.acos(Et(t/this.radius,-1,1))),this}clone(){return new this.constructor().copy(this)}}typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("register",{detail:{revision:Pa}}));typeof window<"u"&&(window.__THREE__?console.warn("WARNING: Multiple instances of Three.js being imported."):window.__THREE__=Pa);const Wc={type:"change"},Ro={type:"start"},qc={type:"end"};class Ty extends pi{constructor(e,t){super(),this.object=e,this.domElement=t,this.domElement.style.touchAction="none",this.enabled=!0,this.target=new V,this.minDistance=0,this.maxDistance=1/0,this.minZoom=0,this.maxZoom=1/0,this.minPolarAngle=0,this.maxPolarAngle=Math.PI,this.minAzimuthAngle=-1/0,this.maxAzimuthAngle=1/0,this.enableDamping=!1,this.dampingFactor=.05,this.enableZoom=!0,this.zoomSpeed=1,this.enableRotate=!0,this.rotateSpeed=1,this.enablePan=!0,this.panSpeed=1,this.screenSpacePanning=!0,this.keyPanSpeed=7,this.autoRotate=!1,this.autoRotateSpeed=2,this.keys={LEFT:"ArrowLeft",UP:"ArrowUp",RIGHT:"ArrowRight",BOTTOM:"ArrowDown"},this.mouseButtons={LEFT:gi.ROTATE,MIDDLE:gi.DOLLY,RIGHT:gi.PAN},this.touches={ONE:_i.ROTATE,TWO:_i.DOLLY_PAN},this.target0=this.target.clone(),this.position0=this.object.position.clone(),this.zoom0=this.object.zoom,this._domElementKeyEvents=null,this.getPolarAngle=function(){return o.phi},this.getAzimuthalAngle=function(){return o.theta},this.getDistance=function(){return this.object.position.distanceTo(this.target)},this.listenToKeyEvents=function(C){C.addEventListener("keydown",oe),this._domElementKeyEvents=C},this.saveState=function(){i.target0.copy(i.target),i.position0.copy(i.object.position),i.zoom0=i.object.zoom},this.reset=function(){i.target.copy(i.target0),i.object.position.copy(i.position0),i.object.zoom=i.zoom0,i.object.updateProjectionMatrix(),i.dispatchEvent(Wc),i.update(),s=r.NONE},this.update=function(){const C=new V,N=new hi().setFromUnitVectors(e.up,new V(0,1,0)),be=N.clone().invert(),Te=new V,Se=new hi,Ce=2*Math.PI;return function(){const Re=i.object.position;C.copy(Re).sub(i.target),C.applyQuaternion(N),o.setFromVector3(C),i.autoRotate&&s===r.NONE&&L(B()),i.enableDamping?(o.theta+=l.theta*i.dampingFactor,o.phi+=l.phi*i.dampingFactor):(o.theta+=l.theta,o.phi+=l.phi);let ze=i.minAzimuthAngle,Ye=i.maxAzimuthAngle;return isFinite(ze)&&isFinite(Ye)&&(ze<-Math.PI?ze+=Ce:ze>Math.PI&&(ze-=Ce),Ye<-Math.PI?Ye+=Ce:Ye>Math.PI&&(Ye-=Ce),ze<=Ye?o.theta=Math.max(ze,Math.min(Ye,o.theta)):o.theta=o.theta>(ze+Ye)/2?Math.max(ze,o.theta):Math.min(Ye,o.theta)),o.phi=Math.max(i.minPolarAngle,Math.min(i.maxPolarAngle,o.phi)),o.makeSafe(),o.radius*=c,o.radius=Math.max(i.minDistance,Math.min(i.maxDistance,o.radius)),i.enableDamping===!0?i.target.addScaledVector(u,i.dampingFactor):i.target.add(u),C.setFromSpherical(o),C.applyQuaternion(be),Re.copy(i.target).add(C),i.object.lookAt(i.target),i.enableDamping===!0?(l.theta*=1-i.dampingFactor,l.phi*=1-i.dampingFactor,u.multiplyScalar(1-i.dampingFactor)):(l.set(0,0,0),u.set(0,0,0)),c=1,f||Te.distanceToSquared(i.object.position)>a||8*(1-Se.dot(i.object.quaternion))>a?(i.dispatchEvent(Wc),Te.copy(i.object.position),Se.copy(i.object.quaternion),f=!1,!0):!1}}(),this.dispose=function(){i.domElement.removeEventListener("contextmenu",F),i.domElement.removeEventListener("pointerdown",H),i.domElement.removeEventListener("pointercancel",le),i.domElement.removeEventListener("wheel",me),i.domElement.removeEventListener("pointermove",X),i.domElement.removeEventListener("pointerup",K),i._domElementKeyEvents!==null&&i._domElementKeyEvents.removeEventListener("keydown",oe)};const i=this,r={NONE:-1,ROTATE:0,DOLLY:1,PAN:2,TOUCH_ROTATE:3,TOUCH_PAN:4,TOUCH_DOLLY_PAN:5,TOUCH_DOLLY_ROTATE:6};let s=r.NONE;const a=1e-6,o=new Vc,l=new Vc;let c=1;const u=new V;let f=!1;const h=new Ue,m=new Ue,g=new Ue,p=new Ue,d=new Ue,_=new Ue,w=new Ue,y=new Ue,T=new Ue,S=[],R={};function B(){return 2*Math.PI/60/60*i.autoRotateSpeed}function v(){return Math.pow(.95,i.zoomSpeed)}function L(C){l.theta-=C}function O(C){l.phi-=C}const $=function(){const C=new V;return function(be,Te){C.setFromMatrixColumn(Te,0),C.multiplyScalar(-be),u.add(C)}}(),he=function(){const C=new V;return function(be,Te){i.screenSpacePanning===!0?C.setFromMatrixColumn(Te,1):(C.setFromMatrixColumn(Te,0),C.crossVectors(i.object.up,C)),C.multiplyScalar(be),u.add(C)}}(),z=function(){const C=new V;return function(be,Te){const Se=i.domElement;if(i.object.isPerspectiveCamera){const Ce=i.object.position;C.copy(Ce).sub(i.target);let we=C.length();we*=Math.tan(i.object.fov/2*Math.PI/180),$(2*be*we/Se.clientHeight,i.object.matrix),he(2*Te*we/Se.clientHeight,i.object.matrix)}else i.object.isOrthographicCamera?($(be*(i.object.right-i.object.left)/i.object.zoom/Se.clientWidth,i.object.matrix),he(Te*(i.object.top-i.object.bottom)/i.object.zoom/Se.clientHeight,i.object.matrix)):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - pan disabled."),i.enablePan=!1)}}();function U(C){i.object.isPerspectiveCamera?c/=C:i.object.isOrthographicCamera?(i.object.zoom=Math.max(i.minZoom,Math.min(i.maxZoom,i.object.zoom*C)),i.object.updateProjectionMatrix(),f=!0):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),i.enableZoom=!1)}function ee(C){i.object.isPerspectiveCamera?c*=C:i.object.isOrthographicCamera?(i.object.zoom=Math.max(i.minZoom,Math.min(i.maxZoom,i.object.zoom/C)),i.object.updateProjectionMatrix(),f=!0):(console.warn("WARNING: OrbitControls.js encountered an unknown camera type - dolly/zoom disabled."),i.enableZoom=!1)}function se(C){h.set(C.clientX,C.clientY)}function te(C){w.set(C.clientX,C.clientY)}function W(C){p.set(C.clientX,C.clientY)}function de(C){m.set(C.clientX,C.clientY),g.subVectors(m,h).multiplyScalar(i.rotateSpeed);const N=i.domElement;L(2*Math.PI*g.x/N.clientHeight),O(2*Math.PI*g.y/N.clientHeight),h.copy(m),i.update()}function ue(C){y.set(C.clientX,C.clientY),T.subVectors(y,w),T.y>0?U(v()):T.y<0&&ee(v()),w.copy(y),i.update()}function q(C){d.set(C.clientX,C.clientY),_.subVectors(d,p).multiplyScalar(i.panSpeed),z(_.x,_.y),p.copy(d),i.update()}function Y(C){C.deltaY<0?ee(v()):C.deltaY>0&&U(v()),i.update()}function fe(C){let N=!1;switch(C.code){case i.keys.UP:C.ctrlKey||C.metaKey||C.shiftKey?O(2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):z(0,i.keyPanSpeed),N=!0;break;case i.keys.BOTTOM:C.ctrlKey||C.metaKey||C.shiftKey?O(-2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):z(0,-i.keyPanSpeed),N=!0;break;case i.keys.LEFT:C.ctrlKey||C.metaKey||C.shiftKey?L(2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):z(i.keyPanSpeed,0),N=!0;break;case i.keys.RIGHT:C.ctrlKey||C.metaKey||C.shiftKey?L(-2*Math.PI*i.rotateSpeed/i.domElement.clientHeight):z(-i.keyPanSpeed,0),N=!0;break}N&&(C.preventDefault(),i.update())}function _e(){if(S.length===1)h.set(S[0].pageX,S[0].pageY);else{const C=.5*(S[0].pageX+S[1].pageX),N=.5*(S[0].pageY+S[1].pageY);h.set(C,N)}}function I(){if(S.length===1)p.set(S[0].pageX,S[0].pageY);else{const C=.5*(S[0].pageX+S[1].pageX),N=.5*(S[0].pageY+S[1].pageY);p.set(C,N)}}function P(){const C=S[0].pageX-S[1].pageX,N=S[0].pageY-S[1].pageY,be=Math.sqrt(C*C+N*N);w.set(0,be)}function ae(){i.enableZoom&&P(),i.enablePan&&I()}function ie(){i.enableZoom&&P(),i.enableRotate&&_e()}function ve(C){if(S.length==1)m.set(C.pageX,C.pageY);else{const be=Me(C),Te=.5*(C.pageX+be.x),Se=.5*(C.pageY+be.y);m.set(Te,Se)}g.subVectors(m,h).multiplyScalar(i.rotateSpeed);const N=i.domElement;L(2*Math.PI*g.x/N.clientHeight),O(2*Math.PI*g.y/N.clientHeight),h.copy(m)}function xe(C){if(S.length===1)d.set(C.pageX,C.pageY);else{const N=Me(C),be=.5*(C.pageX+N.x),Te=.5*(C.pageY+N.y);d.set(be,Te)}_.subVectors(d,p).multiplyScalar(i.panSpeed),z(_.x,_.y),p.copy(d)}function Ee(C){const N=Me(C),be=C.pageX-N.x,Te=C.pageY-N.y,Se=Math.sqrt(be*be+Te*Te);y.set(0,Se),T.set(0,Math.pow(y.y/w.y,i.zoomSpeed)),U(T.y),w.copy(y)}function b(C){i.enableZoom&&Ee(C),i.enablePan&&xe(C)}function A(C){i.enableZoom&&Ee(C),i.enableRotate&&ve(C)}function H(C){i.enabled!==!1&&(S.length===0&&(i.domElement.setPointerCapture(C.pointerId),i.domElement.addEventListener("pointermove",X),i.domElement.addEventListener("pointerup",K)),j(C),C.pointerType==="touch"?M(C):pe(C))}function X(C){i.enabled!==!1&&(C.pointerType==="touch"?x(C):re(C))}function K(C){Q(C),S.length===0&&(i.domElement.releasePointerCapture(C.pointerId),i.domElement.removeEventListener("pointermove",X),i.domElement.removeEventListener("pointerup",K)),i.dispatchEvent(qc),s=r.NONE}function le(C){Q(C)}function pe(C){let N;switch(C.button){case 0:N=i.mouseButtons.LEFT;break;case 1:N=i.mouseButtons.MIDDLE;break;case 2:N=i.mouseButtons.RIGHT;break;default:N=-1}switch(N){case gi.DOLLY:if(i.enableZoom===!1)return;te(C),s=r.DOLLY;break;case gi.ROTATE:if(C.ctrlKey||C.metaKey||C.shiftKey){if(i.enablePan===!1)return;W(C),s=r.PAN}else{if(i.enableRotate===!1)return;se(C),s=r.ROTATE}break;case gi.PAN:if(C.ctrlKey||C.metaKey||C.shiftKey){if(i.enableRotate===!1)return;se(C),s=r.ROTATE}else{if(i.enablePan===!1)return;W(C),s=r.PAN}break;default:s=r.NONE}s!==r.NONE&&i.dispatchEvent(Ro)}function re(C){switch(s){case r.ROTATE:if(i.enableRotate===!1)return;de(C);break;case r.DOLLY:if(i.enableZoom===!1)return;ue(C);break;case r.PAN:if(i.enablePan===!1)return;q(C);break}}function me(C){i.enabled===!1||i.enableZoom===!1||s!==r.NONE||(C.preventDefault(),i.dispatchEvent(Ro),Y(C),i.dispatchEvent(qc))}function oe(C){i.enabled===!1||i.enablePan===!1||fe(C)}function M(C){switch(ce(C),S.length){case 1:switch(i.touches.ONE){case _i.ROTATE:if(i.enableRotate===!1)return;_e(),s=r.TOUCH_ROTATE;break;case _i.PAN:if(i.enablePan===!1)return;I(),s=r.TOUCH_PAN;break;default:s=r.NONE}break;case 2:switch(i.touches.TWO){case _i.DOLLY_PAN:if(i.enableZoom===!1&&i.enablePan===!1)return;ae(),s=r.TOUCH_DOLLY_PAN;break;case _i.DOLLY_ROTATE:if(i.enableZoom===!1&&i.enableRotate===!1)return;ie(),s=r.TOUCH_DOLLY_ROTATE;break;default:s=r.NONE}break;default:s=r.NONE}s!==r.NONE&&i.dispatchEvent(Ro)}function x(C){switch(ce(C),s){case r.TOUCH_ROTATE:if(i.enableRotate===!1)return;ve(C),i.update();break;case r.TOUCH_PAN:if(i.enablePan===!1)return;xe(C),i.update();break;case r.TOUCH_DOLLY_PAN:if(i.enableZoom===!1&&i.enablePan===!1)return;b(C),i.update();break;case r.TOUCH_DOLLY_ROTATE:if(i.enableZoom===!1&&i.enableRotate===!1)return;A(C),i.update();break;default:s=r.NONE}}function F(C){i.enabled!==!1&&C.preventDefault()}function j(C){S.push(C)}function Q(C){delete R[C.pointerId];for(let N=0;N<S.length;N++)if(S[N].pointerId==C.pointerId){S.splice(N,1);return}}function ce(C){let N=R[C.pointerId];N===void 0&&(N=new Ue,R[C.pointerId]=N),N.set(C.pageX,C.pageY)}function Me(C){const N=C.pointerId===S[0].pointerId?S[1]:S[0];return R[N.pointerId]}i.domElement.addEventListener("contextmenu",F),i.domElement.addEventListener("pointerdown",H),i.domElement.addEventListener("pointercancel",le),i.domElement.addEventListener("wheel",me,{passive:!1}),this.update()}}var Ay=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},sa={},Cy={get exports(){return sa},set exports(n){sa=n}};(function(n,e){(function(t,i){n.exports=i()})(Ay,function(){var t=function(){function i(m){return a.appendChild(m.dom),m}function r(m){for(var g=0;g<a.children.length;g++)a.children[g].style.display=g===m?"block":"none";s=m}var s=0,a=document.createElement("div");a.style.cssText="position:fixed;top:0;left:0;cursor:pointer;opacity:0.9;z-index:10000",a.addEventListener("click",function(m){m.preventDefault(),r(++s%a.children.length)},!1);var o=(performance||Date).now(),l=o,c=0,u=i(new t.Panel("FPS","#0ff","#002")),f=i(new t.Panel("MS","#0f0","#020"));if(self.performance&&self.performance.memory)var h=i(new t.Panel("MB","#f08","#201"));return r(0),{REVISION:16,dom:a,addPanel:i,showPanel:r,begin:function(){o=(performance||Date).now()},end:function(){c++;var m=(performance||Date).now();if(f.update(m-o,200),m>l+1e3&&(u.update(1e3*c/(m-l),100),l=m,c=0,h)){var g=performance.memory;h.update(g.usedJSHeapSize/1048576,g.jsHeapSizeLimit/1048576)}return m},update:function(){o=this.end()},domElement:a,setMode:r}};return t.Panel=function(i,r,s){var a=1/0,o=0,l=Math.round,c=l(window.devicePixelRatio||1),u=80*c,f=48*c,h=3*c,m=2*c,g=3*c,p=15*c,d=74*c,_=30*c,w=document.createElement("canvas");w.width=u,w.height=f,w.style.cssText="width:80px;height:48px";var y=w.getContext("2d");return y.font="bold "+9*c+"px Helvetica,Arial,sans-serif",y.textBaseline="top",y.fillStyle=s,y.fillRect(0,0,u,f),y.fillStyle=r,y.fillText(i,h,m),y.fillRect(g,p,d,_),y.fillStyle=s,y.globalAlpha=.9,y.fillRect(g,p,d,_),{dom:w,update:function(T,S){a=Math.min(a,T),o=Math.max(o,T),y.fillStyle=s,y.globalAlpha=1,y.fillRect(0,0,u,p),y.fillStyle=r,y.fillText(l(T)+" "+i+" ("+l(a)+"-"+l(o)+")",h,m),y.drawImage(w,g+c,p,d-c,_,g,p,d-c,_),y.fillRect(g+d-c,p,c,_),y.fillStyle=s,y.globalAlpha=.9,y.fillRect(g+d-c,p,c,l((1-T/S)*_))}}},t})})(Cy);const Ly=sa,Py="/assets/rain-a48adeaf.png",Ry=Sa({__name:"raining",setup(n){const e=cu(null);let t=new gy,i,r,s,a,o;const l=5e3;Ma(()=>{c(e.value.clientWidth,e.value.clientHeight),u(e.value.clientWidth,e.value.clientHeight),h(),m(),g(),f(),p()});const c=(d,_)=>{i=new Bt(75,d/_,.1,40),i.position.set(0,0,40),t.add(i)},u=(d,_)=>{r=new Cf,r.setSize(d,_),e.value.appendChild(r.domElement),r.render(t,i)},f=()=>{a=new Ly,e.value.appendChild(a.dom)},h=()=>{let d=new Ey(4210752);t.add(d);let _=new wy(16777215);_.position.set(1,1,1),t.add(_)},m=()=>{s=new Ty(i,r.domElement),s.enableDamping=!0,s.enableZoom=!0,s.autoRotate=!1,s.enablePan=!0},g=()=>{if(s.update(),r.render(t,i),a&&a.update(),o){const d=o.geometry.getAttribute("position").array;for(let _=0;_<l*3;_+=3)d[_+1]-=Math.random()*.5,d[_+1]<-40&&(d[_+1]=40);o.geometry.getAttribute("position").needsUpdate=!0}requestAnimationFrame(g)},p=()=>{let d=new wn,_=new Float32Array(l*3);for(let S=0;S<l*3;S++)_[S]=(Math.random()-.5)*100;d.setAttribute("position",new Qt(_,3));let y=new My().load(Py),T=new Lf({size:1,transparent:!0,opacity:.5,vertexColors:!1,sizeAttenuation:!0,color:15592941,depthTest:!0,depthWrite:!1,map:y,alphaMap:y,blending:$o});o=new _y(d,T),t.add(o)};return window.addEventListener("resize",()=>{i.aspect=e.value.clientWidth/e.value.clientHeight,i.updateProjectionMatrix(),r.setSize(e.value.clientWidth,e.value.clientHeight),r.setPixelRatio(window.devicePixelRatio)}),(d,_)=>(Uu(),zu("div",{id:"canvas",ref_key:"canvas",ref:e},null,512))}});let Dy=[{path:"/raining",name:"raining",component:Ry}];const Iy=xm({history:Fp(),routes:Dy}),Df=up(mp);Df.use(Iy);Df.mount("#app");
